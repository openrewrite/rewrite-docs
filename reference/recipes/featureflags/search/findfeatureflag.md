...
Now that `com.yourorg.FindFeatureFlagExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-feature-flags:0.7.1 in your build file:
{% tabs %}
{% tab title="Gradle" %}
