...
Now that `com.yourorg.RemoveIsEnabledExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-feature-flags:0.8.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
