...
* [Remove a String feature flag for feature key](../../featureflags/removestringflag.md)
...
Now that `com.yourorg.RemoveStringVariationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-feature-flags:0.8.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.featureflags.launchdarkly.RemoveStringVariation)
