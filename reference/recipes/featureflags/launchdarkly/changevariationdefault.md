...
Now that `com.yourorg.ChangeVariationDefaultExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-feature-flags:0.7.2 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.featureflags.launchdarkly.ChangeVariationDefault)
