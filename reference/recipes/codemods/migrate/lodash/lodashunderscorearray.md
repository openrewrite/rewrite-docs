...
- `_.last(x, n)` -> `x.slice(x.length - n)`_
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.codemods.migrate.lodash.LodashUnderscoreArray)
