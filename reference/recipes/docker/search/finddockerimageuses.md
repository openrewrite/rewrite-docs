...
[GitHub](https://github.com/openrewrite/rewrite-docker/blob/main/src/main/java/org/openrewrite/docker/search/FindDockerImageUses.java), [Issue Tracker](https://github.com/openrewrite/rewrite-docker/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-docker/1.0.6/jar)
...
This recipe has no required configuration options. It can be activated by adding a dependency on `org.openrewrite.recipe:rewrite-docker:1.0.6` in your build file or by running a shell command (in which case no build changes are needed): 
{% tabs %}
{% tab title="Gradle" %}
...
dependencies {
    rewrite("org.openrewrite.recipe:rewrite-docker:1.0.6")
}
```
{% endcode %}
