...
Now that `com.yourorg.DeleteContentExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-hcl:7.27.1 in your build file:
...
Recipes can also be activated directly from the commandline by adding the argument `-Drewrite.activeRecipescom.yourorg.DeleteContentExample`
