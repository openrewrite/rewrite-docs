...
Now that `com.yourorg.MoveContentToFileExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-hcl:7.33.0 in your build file:
