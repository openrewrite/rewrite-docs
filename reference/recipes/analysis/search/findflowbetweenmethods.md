...
Now that `com.yourorg.FindFlowBetweenMethodsExample` has been defined, activate it and take a dependency on org.openrewrite.meta:rewrite-analysis:2.11.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
