...
Now that `com.yourorg.FindMissingOrInvalidLabelExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.0.5 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.kubernetes.search.FindMissingOrInvalidLabel
```
{% endcode %}
{% endtab %}
{% endtabs %}
