...
Now that `com.yourorg.FindMissingOrInvalidLabelExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.0.6 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
## Contributors
* [Jon Brisbin](mailto:jon@moderne.io), * [traceyyoshima](mailto:tracey.yoshima@gmail.com), * [Knut Wannheden](mailto:knut.wannheden@gmail.com), * Aaron Gershman, * Tyler Van Gorder
