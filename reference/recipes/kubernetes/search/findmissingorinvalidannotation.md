...
Now that `com.yourorg.FindMissingOrInvalidAnnotationExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.0.6 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
## Contributors
[Jon Brisbin](mailto:jon@jbrisbin.com), Aaron Gershman, [Knut Wannheden](mailto:knut.wannheden@gmail.com)
