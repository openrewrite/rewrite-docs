...
Now that `com.yourorg.FindDisallowedImageTagsExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.8.3 in your build file:
{% tabs %}
{% tab title="Gradle" %}
