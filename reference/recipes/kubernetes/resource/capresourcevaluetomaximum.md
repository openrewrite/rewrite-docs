...
Now that `com.yourorg.CapResourceValueToMaximumExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.1.1 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run . --recipe CapResourceValueToMaximum
```
{% endcode %}
{% endtab %}
{% endtabs %}
