...
Now that `com.yourorg.FindExceedsResourceRatioExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.0.9 in your build file:
{% tabs %}
{% tab title="Gradle" %}
