 ...
 **org.openrewrite.kubernetes.services.FindServicesByType** _Type of Kubernetes `Service` to find._
...
Now that `com.yourorg.FindServicesByTypeExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:1.7.0 in your build file:
