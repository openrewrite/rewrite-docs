...
| :--- | :--- | :--- |
| `String` | oldKeyPath | An XPath expression to locate a YAML key/value pair to copy. |
| `String` | newKey | An XPath expression for where the new value should be copied to. |
