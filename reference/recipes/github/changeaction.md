...
Now that `com.yourorg.ChangeActionExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.8.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
