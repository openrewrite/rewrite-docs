...
Now that `com.yourorg.AddCronTriggerExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.0.6 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.github.AddCronTrigger
```
{% endcode %}
{% endtab %}
{% endtabs %}
