...
Now that `com.yourorg.ChangeActionVersionExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.1.6 in your build file:
{% tabs %}
{% tab title="Gradle" %}
