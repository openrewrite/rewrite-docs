...
Now that `com.yourorg.ChangeVariationDefaultExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-launchdarkly:0.2.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
