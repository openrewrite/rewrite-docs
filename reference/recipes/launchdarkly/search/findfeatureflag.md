...
| -- | -- | -- |
| `FeatureFlagType` | flagType | *Optional*. The feature flag's type. |
| `String` | featureKey | *Optional*. The unique key for the feature flag. |
...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.launchdarkly.search.FindFeatureFlag
```
{% endcode %}
{% endtab %}
