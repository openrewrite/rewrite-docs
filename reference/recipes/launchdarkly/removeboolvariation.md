...
Now that `com.yourorg.RemoveBoolVariationExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-launchdarkly:0.3.1 in your build file:
{% tabs %}
{% tab title="Gradle" %}
