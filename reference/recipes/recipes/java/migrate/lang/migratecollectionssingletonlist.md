...
** org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonList**
_Replaces `Collections.singletonList(<args>)))` with `List.Of(<args>)`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonList")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonList</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonList`
