...
** org.openrewrite.java.migrate.lang.MigrateCollectionsUnmodifiableList**
_Replaces `unmodifiableList(java.util.Arrays asList(<args>))` with `List.Of(<args>)`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.lang.MigrateCollectionsUnmodifiableList")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.lang.MigrateCollectionsUnmodifiableList</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.lang.MigrateCollectionsUnmodifiableList`
