...
| :--- | :--- | :--- |
| `String` | methodPattern | A method pattern, expressed as a [pointcut expression](https://github.com/openrewrite/rewrite-docs/tree/ec3ef336eb2908e0b56df373d4f19d39015fcdf4/v1beta/pointcut-expressions/README.md), that is used to find matching method declarations/invocations. |
