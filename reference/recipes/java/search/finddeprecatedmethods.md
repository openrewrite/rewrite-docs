...
| -- | -- | -- |
| `String` | methodPattern | *Optional*. A method pattern, expressed as a [pointcut expression](/v1beta/pointcut-expressions), that is used to find matching method invocations. |
