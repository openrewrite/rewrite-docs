 ...
 **org.openrewrite.java.search.FindAnnotations** _Find all annotations matching the annotation pattern._
...
| :--- | :--- | :--- |
| `String` | annotationPattern | An annotation pattern, expressed as a [pointcut expression](https://github.com/openrewrite/rewrite-docs/tree/eef3e55c64e6b72ab7b6688fa2444b2f41c16183/v1beta/pointcut-expressions/README.md). |
