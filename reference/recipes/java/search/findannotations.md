...
| --------- | -------------------- | ------------------------------------------------------------------------------------ |
| `String`  | annotationPattern    | An annotation pattern, expressed as a [method pattern](../../../method-patterns.md). |
...
Recipes can also be activated directly from the commandline by adding the argument `-Drewrite.activeRecipes=com.yourorg.FindAnnotationsExample`
