...
| :--- | :--- | :--- |
| `String` | methodPattern | A method pattern, expressed as a [pointcut expression](../../../../v1beta/pointcut-expressions.md), that is used to find matching method invocations. |
