...
Now that `com.yourorg.SimplifyAssertJAssertionExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-testing-frameworks:2.16.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
