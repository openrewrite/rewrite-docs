...
Now that `com.yourorg.ExplicitContainerImageExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-testing-frameworks:2.1.4 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run . --recipe ExplicitContainerImage
```
{% endcode %}
{% endtab %}
{% endtabs %}
