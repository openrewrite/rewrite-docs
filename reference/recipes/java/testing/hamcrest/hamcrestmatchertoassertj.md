...
| -- | -- | -- |
| `String` | matcher | *Optional*. The Hamcrest `Matcher` to migrate to JUnit5. |
...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.testing.hamcrest.HamcrestMatcherToAssertJ
```
{% endcode %}
{% endtab %}
