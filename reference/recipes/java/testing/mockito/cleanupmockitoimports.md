 ...
 **org.openrewrite.java.testing.mockito.CleanupMockitoImports** _Removes unused imports `org.mockito` import symbols._
...
Recipes can also be activated directly from the commandline by adding the argument `-DactiveRecipe=org.openrewrite.java.testing.mockito.CleanupMockitoImports` ts\`
