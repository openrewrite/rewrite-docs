# Rewrite JMockit Expectations and Verifications

**org.openrewrite.java.testing.jmockit.JMockitBlockToMockito**

_Rewrites JMockit `Expectations and Verifications` blocks to Mockito statements._
...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-testing-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.testing.jmockit.JMockitBlockToMockito 
```
{% endcode %}
{% endtab %}
