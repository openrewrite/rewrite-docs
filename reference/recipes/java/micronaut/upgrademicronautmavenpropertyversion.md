...
Now that `com.yourorg.UpgradeMicronautMavenPropertyVersionExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-micronaut:2.8.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
