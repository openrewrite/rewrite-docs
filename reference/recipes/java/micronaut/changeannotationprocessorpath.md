...
Now that `com.yourorg.ChangeAnnotationProcessorPathExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-micronaut:2.2.2 in your build file:
{% tabs %}
{% tab title="Gradle" %}
