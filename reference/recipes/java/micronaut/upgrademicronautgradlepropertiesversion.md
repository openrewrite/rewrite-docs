...
Now that `com.yourorg.UpgradeMicronautGradlePropertiesVersionExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-micronaut:2.1.5 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run . --recipe UpgradeMicronautGradlePropertiesVersion
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
## Contributors
* [Patrick](mailto:patway99@gmail.com), * [Sam Snyder](mailto:sam@moderne.io), * [Knut Wannheden](mailto:knut@moderne.io), * [Jeremy Grelle](mailto:grellej@unityfoundation.io)
