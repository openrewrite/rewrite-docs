...
Now that `com.yourorg.RemoveAnnotationProcessorPathExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-micronaut:2.7.2 in your build file:
{% tabs %}
{% tab title="Gradle" %}
