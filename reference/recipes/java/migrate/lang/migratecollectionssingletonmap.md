...
** org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonMap**
_Replaces `Collections.singletonMap(<args>)))` with `Map.Of(<args>)`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonMap")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonMap</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonMap`
