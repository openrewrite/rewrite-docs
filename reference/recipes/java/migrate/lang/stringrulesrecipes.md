...
[GitHub](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/lang/StringRulesRecipes.java), [Issue Tracker](https://github.com/openrewrite/rewrite-migrate-java/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-migrate-java/2.1.0/jar)
...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.lang.StringRulesRecipes
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
* [Refaster template `StringRules.RedundantCall`](../../../java/migrate/lang/stringrulesrecipes$redundantcallrecipe.md)
* [Refaster template `StringRules.IndexOfString`](../../../java/migrate/lang/stringrulesrecipes$indexofstringrecipe.md)
* [Refaster template `StringRules.IndexOfChar`](../../../java/migrate/lang/stringrulesrecipes$indexofcharrecipe.md)
* [Refaster template `StringRules.UseEqualsIgnoreCase`](../../../java/migrate/lang/stringrulesrecipes$useequalsignorecaserecipe.md)
