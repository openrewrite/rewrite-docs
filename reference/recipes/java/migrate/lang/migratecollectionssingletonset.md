...
** org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonSet**
_Replaces `Collections.singleton(<args>)))` with `Set.Of(<args>)`._
...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonSet")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonSet</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.lang.MigrateCollectionsSingletonSet`
