...
_Try to apply local variable type inference `var` to primitiv variables where possible.This recipe will not touch variable declaration with initializer containing ternary operators._
