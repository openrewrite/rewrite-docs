...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.lang.MigrateClassNewInstanceToGetDeclaredConstructorNewInstance
```
{% endcode %}
{% endtab %}
...
## Contributors
[Patrick](mailto:patway99@gmail.com), [Sam Snyder](mailto:sam@moderne.io), Tyler Van Gorder, [Jonathan Schnéider](mailto:jkschneider@gmail.com), Josh Soref, [Knut Wannheden](mailto:knut@moderne.io), Aaron Gershman, [Tim te Beek](mailto:timtebeek@gmail.com)
