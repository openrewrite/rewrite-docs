...
Now that `com.yourorg.UseTabsOrSpacesExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.4.2 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
{% code title="shell" %}
```shell
mod run . --recipe UseTabsOrSpaces
```
{% endcode %}
{% endtab %}
{% endtabs %}
