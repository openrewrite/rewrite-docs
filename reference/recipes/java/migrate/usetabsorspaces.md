...
Now that `com.yourorg.UseTabsOrSpacesExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.20.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
