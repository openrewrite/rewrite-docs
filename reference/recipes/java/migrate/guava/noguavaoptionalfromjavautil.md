...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.guava.NoGuavaOptionalFromJavaUtil
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://public.moderne.io/recipes/org.openrewrite.java.migrate.guava.NoGuavaOptionalFromJavaUtil)
