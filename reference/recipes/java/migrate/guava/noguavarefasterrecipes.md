...
* [`Preconditions.checkNotNull` to `Objects.requireNonNull`](../../../java/migrate/guava/noguavarefasterrecipes$preconditionschecknotnulltoobjectsrequirenonnullrecipe.md)
* [`Preconditions.checkNotNull` with message to `Objects.requireNonNull`](../../../java/migrate/guava/noguavarefasterrecipes$preconditionschecknotnullwithmessagetoobjectsrequirenonnullrecipe.md)
* [`String.valueof(String)` to `String`](../../../java/migrate/guava/noguavarefasterrecipes$stringvalueofstringrecipe.md)
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.java.migrate.guava.NoGuavaRefasterRecipes)
