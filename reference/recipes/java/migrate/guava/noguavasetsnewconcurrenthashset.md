 ...
 **org.openrewrite.java.migrate.guava.NoGuavaSetsNewConcurrentHashSet** _Prefer the Java standard library over third-party usage of Guava in simple cases like this._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.guava.NoGuavaSetsNewConcurrentHashSet`
