 ...
 **org.openrewrite.java.migrate.guava.NoGuavaImmutableListOf** _Replaces `ImmutableList.of(..)` if the returned type is immediately down-cast._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.guava.NoGuavaImmutableListOf`
