...
| -- | -- | -- | -- |
| `String` | methodPattern | *Optional*. Optionally limit the search to declarations that match the provided [method pattern](/reference/method-patterns.md). | `java.util.List add(..)` |
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.java.migrate.search.FindInternalJavaxApis)
