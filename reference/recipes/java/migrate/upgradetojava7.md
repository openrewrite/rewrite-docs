...
* [Replace `java.lang.Math random()` with `ThreadLocalRandom nextDouble()`](../../java/migrate/util/replacemathrandomwiththreadlocalrandomrecipe.md)
...
## Contributors
Chuka Obinabo, Anu Ramamoorthy, Daryl Robbins, [Sam Snyder](mailto:sam@moderne.io), [Tim te Beek](mailto:timtebeek@gmail.com), [Tim te Beek](mailto:tim@moderne.io)
