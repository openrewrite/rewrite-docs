...
| -- | -- | -- | -- |
| `String` | getPeerMethodPattern | *Optional*. The [method pattern](/reference/method-patterns.md) to match and replace. | `java.awt.* getPeer()` |
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.java.migrate.ReplaceAWTGetPeerMethod)
