...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.plexus.PlexusFileUtilsRecipes$GetFileRecipe
```
{% endcode %}
{% endtab %}
