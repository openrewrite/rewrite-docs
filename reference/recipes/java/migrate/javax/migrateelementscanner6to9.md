...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.javax.MigrateElementScanner6To9
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.java.migrate.javax.MigrateElementScanner6To9
```
{% endcode %}
{% endtab %}
{% endtabs %}
