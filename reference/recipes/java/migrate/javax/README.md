...
* [Add JAX-WS run-time dependency to a Maven project](addjaxwsruntime.md)
* [Add JAXB run-time dependency to a Maven project](addjaxbruntime.md)
...
* [Replace `javax.xml.bind:jaxb-api with `jakarta.xml.bind:jakarta.xml.bind-api`](replacejavaxjaxbwithjakarta.md)
* [Replace `javax.xml.ws:jaxws-api` with `jakarta.xml.ws:jakarta.xml.ws-api`](replacejavaxjaxwswithjakarta.md)
