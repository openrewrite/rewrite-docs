...
* [Use the latest JAX-WS API and runtime for Jakarta EE 8](./addjaxwsruntimeaddjaxwsruntimegradle.md)
* [Use the latest JAX-WS API and runtime for Jakarta EE 8](./addjaxwsruntimeaddjaxwsruntimemaven.md)
