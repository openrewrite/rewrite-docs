...
Now that `com.yourorg.ChangeMethodInvocationReturnTypeExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.2.1 in your build file:
{% tabs %}
{% tab title="Gradle" %}
