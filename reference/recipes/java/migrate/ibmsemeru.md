...
* [Do not use `java.xml.ws` module in WebSphere Liberty](../../java/migrate/removedjavaxmlwsmoduleprovided.md)
* [Do not use `java.xml.bind` and `java.activation` modules in WebSphere Liberty](../../java/migrate/removedjaxbmoduleprovided.md)
