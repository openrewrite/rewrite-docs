...
_This recipe will apply changes commonly needed when upgrading Java versions. The solutions provided in this list are solutions only availible in IBM Semeru Runtimes._
...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.IBMSemeru
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.java.migrate.IBMSemeru
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
description: This recipe will apply changes commonly needed when upgrading Java versions. The solutions provided in this list are solutions only availible in IBM Semeru Runtimes.
