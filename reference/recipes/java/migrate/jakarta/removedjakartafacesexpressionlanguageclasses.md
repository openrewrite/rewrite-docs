...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.migrate.jakarta.RemovedJakartaFacesExpressionLanguageClasses
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe RemovedJakartaFacesExpressionLanguageClasses
```
{% endcode %}
{% endtab %}
{% endtabs %}
