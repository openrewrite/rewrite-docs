...
Now that `com.yourorg.UpgradeJavaVersionExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.6.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
