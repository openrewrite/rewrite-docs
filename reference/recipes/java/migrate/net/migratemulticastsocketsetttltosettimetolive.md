 ...
 **org.openrewrite.java.migrate.net.MigrateMulticastSocketSetTTLToSetTimeToLive** _`java.net.MulticastSocket#setTTL(byte)` has been deprecated._
...
Recipes can also be activated directly from the commandline by adding the argument `-DactiveRecipe=org.openrewrite.java.migrate.net.MigrateMulticastSocketSetTTLToSetTimeToLive` ve\`
