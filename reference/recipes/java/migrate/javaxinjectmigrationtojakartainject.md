...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.34.0:run \
  ...
  -DactiveRecipes=org.openrewrite.java.migrate.JavaxInjectMigrationToJakartaInject
```
{% endcode %}
{% endtab %}
{% endtabs %}

Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.java.migrate.JavaxInjectMigrationToJakartaInject`
