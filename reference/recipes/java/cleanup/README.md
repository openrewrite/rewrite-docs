...
* [Add `SerialVersionUID` to a Serializable class when it's missing.](addserialversionuidtoserializable.md)
...
* [No #toString() on String](notostringonstringtype.md)
...
* [Object#finalize() invokes super#finalize()](objectfinalizecallssuper.md)
