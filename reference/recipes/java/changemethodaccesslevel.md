...
| :--- | :--- | :--- |
| `String` | methodPattern | A method pattern, expressed as a [pointcut expression](https://github.com/openrewrite/rewrite-docs/tree/62ee4f2f98d7989196cf8b806bace39e85cbc740/v1beta/pointcut-expressions/README.md), that is used to find matching method declarations/invocations. |
