...
| --------- | -------------- | ------------------------------------------------------------------------------------------------------------ |
| `String`  | methodPattern  | A [method pattern](../../method-patterns.md) that is used to find matching method declarations/invocations.  |
...
Recipes can also be activated directly from the commandline by adding the argument `-Drewrite.activeRecipes=com.yourorg.ChangeMethodAccessLevelExample`
