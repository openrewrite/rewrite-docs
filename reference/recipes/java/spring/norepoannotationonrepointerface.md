...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.NoRepoAnnotationOnRepoInterface 
```
{% endcode %}
{% endtab %}
...
## Contributors
[Alex Boyko](mailto:aboyko@vmware.com), [Knut Wannheden](mailto:knut@moderne.io)
