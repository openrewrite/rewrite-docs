...
Now that `com.yourorg.ReplaceSupportClassWithItsInterfaceExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-spring:5.3.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
