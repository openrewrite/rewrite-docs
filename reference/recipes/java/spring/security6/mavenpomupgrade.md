# Upgrade Maven POM to Spring Security 6.0 from 5.x

**org.openrewrite.java.spring.security6.MavenPomUpgrade**
_Upgrade Maven POM to Spring Security 6.0 from prior 5.x version._
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.security6.MavenPomUpgrade")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.security6.MavenPomUpgrade</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.spring.security6.MavenPomUpgrade
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
name: org.openrewrite.java.spring.security6.MavenPomUpgrade
displayName: Upgrade Maven POM to Spring Security 6.0 from 5.x
description: Upgrade Maven POM to Spring Security 6.0 from prior 5.x version.
tags:
  - spring
  - security
recipeList:
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://public.moderne.io/recipes/org.openrewrite.java.spring.security6.MavenPomUpgrade)
