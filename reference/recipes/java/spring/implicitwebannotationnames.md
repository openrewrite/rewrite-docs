 ...
 **org.openrewrite.java.spring.ImplicitWebAnnotationNames** _Removes implicit web annotation names and rename associated parameters._
...
Recipes can also be activated directly from the commandline by adding the argument `-DactiveRecipe=org.openrewrite.java.spring.ImplicitWebAnnotationNames` es\`
