...
rewrite {
    activeRecipe("org.openrewrite.java.spring.YamlPropertiesToKebabCase")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.YamlPropertiesToKebabCase</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.34.0:run \
  ...
  -DactiveRecipes=org.openrewrite.java.spring.YamlPropertiesToKebabCase
```
{% endcode %}
{% endtab %}
{% endtabs %}

Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.java.spring.YamlPropertiesToKebabCase`
