...
Now that `com.yourorg.UseTlsAmqpConnectionStringExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-spring:5.12.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
## Contributors
[Shannon Pamperl](mailto:shanman190@gmail.com), [Knut Wannheden](mailto:knut@moderne.io), Kun Li, [Nate Danner](mailto:nate@moderne.io), [Jonathan Schnéider](mailto:jkschneider@gmail.com)
