# Migrate Spring Boot properties to 3.0.0

**org.openrewrite.java.spring.boot3.SpringBootProperties\_3\_0\_0** _Migrate properties found in `application.properties` and `application.yml`._
...
displayName: Migrate Spring Boot properties to 3.0.0
