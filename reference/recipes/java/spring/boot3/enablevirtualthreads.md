...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.spring.boot3.EnableVirtualThreads
```
{% endcode %}
{% endtab %}
...
* [Precondition bellwether](../../../config/declarativerecipe$preconditionbellwether.md)
