...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.MigrateErrorControllerPackageName
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.java.spring.boot2.MigrateErrorControllerPackageName
```
{% endcode %}
{% endtab %}
{% endtabs %}
