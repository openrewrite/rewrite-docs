...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.38.2:run \
  ...
  -DactiveRecipes=org.openrewrite.java.spring.boot2.UpgradeSpringBoot_2_1
```
{% endcode %}
{% endtab %}
{% endtabs %}
