 ...
 **org.openrewrite.java.spring.boot2.MigrateRestTemplateBuilderBasicAuthorization** _`RestTemplateBuilder#basicAuthorization` was deprecated in 2.1._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.java.spring.boot2.MigrateRestTemplateBuilderBasicAuthorization`
