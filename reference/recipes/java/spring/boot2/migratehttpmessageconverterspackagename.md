...
**org.openrewrite.java.spring.boot2.MigrateHttpMessageConvertersPackageName** _`org.springframework.boot.autoconfigure.web.HttpMessageConverters` was deprecated in 1.x._
...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.37.0:run \
  ...
  -DactiveRecipes=org.openrewrite.java.spring.boot2.MigrateHttpMessageConvertersPackageName
```
{% endcode %}
{% endtab %}
{% endtabs %}

Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.MigrateHttpMessageConvertersPackageName`
