...
* [Migrate to Spring Boot 2.0 from Spring Boot 1.5](broken-reference)
* [Migrate to Spring Boot 2.1 from Spring Boot 2.0](upgradespringboot\_2\_1.md)
* [Migrate to Spring Boot 2.2 from Spring Boot 2.0 through 2.1](upgradespringboot\_2\_2.md)
* [Migrate to Spring Boot 2.3 from Spring Boot 2.0 through 2.2](upgradespringboot\_2\_3.md)
* [Migrate to Spring Boot 2.4 from Spring Boot 2.0 through 2.3](upgradespringboot\_2\_4.md)
* [Migrate to Spring Boot 2.6 from Spring Boot 2.0 through 2.5](upgradespringboot\_2\_6.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 1.5 through 2.6](springboot1to2migration.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 2.0 through 2.6](upgradespringboot\_2\_7.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 2.0 through 2.6](springbootproperties\_2\_7.md)
...
* [Use `org.springframework.boot.autoconfigure.AutoConfiguration.imports`](moveautoconfigurationtoimportsfile.md)
