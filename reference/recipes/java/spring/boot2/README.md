...
* [Migrate to Spring Boot 2.0 from Spring Boot 1.5](migratespringboot_2_0.md)
* [Migrate to Spring Boot 2.1 from Spring Boot 2.0](upgradespringboot_2_1.md)
* [Migrate to Spring Boot 2.2 from Spring Boot 2.0 through 2.1](upgradespringboot_2_2.md)
* [Migrate to Spring Boot 2.3 from Spring Boot 2.0 through 2.2](upgradespringboot_2_3.md)
* [Migrate to Spring Boot 2.4 from Spring Boot 2.0 through 2.3](upgradespringboot_2_4.md)
* [Migrate to Spring Boot 2.6 from Spring Boot 2.0 through 2.5](upgradespringboot_2_6.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 1.5 through 2.6](springboot1to2migration.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 2.0 through 2.6](upgradespringboot_2_7.md)
* [Migrate to Spring Boot 2.7 from Spring Boot 2.0 through 2.6](springbootproperties_2_7.md)
