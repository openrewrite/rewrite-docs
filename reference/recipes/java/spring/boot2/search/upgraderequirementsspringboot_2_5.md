...
Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipesorg.openrewrite.java.spring.boot2.search.UpgradeRequirementsSpringBoot_2_5`
