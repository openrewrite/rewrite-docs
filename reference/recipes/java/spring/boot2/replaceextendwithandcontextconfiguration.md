...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.ReplaceExtendWithAndContextConfiguration 
```
{% endcode %}
{% endtab %}
...
## Contributors
nbruno, [Knut Wannheden](mailto:knut@moderne.io), Kun Li, [Nick McKinney](mailto:mckinneynichoals@gmail.com)
