...
* [Upgrade to Spring Boot 2.1](upgradespringboot\_2\_1.md)
* [Upgrade to Spring Framework 5.2](../framework/upgradespringframework\_5\_2.md)
...
* [Migrate Spring Boot properties to 2.2](springbootproperties\_2\_2.md)
{% endtab %}
