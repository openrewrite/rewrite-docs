...
displayName: Migrate hibernate validator constraints to javax.
description: `org.hibernate.validator.constraints` were deprecated in 1.x. in favor of their javax counterparts.
recipeList:
