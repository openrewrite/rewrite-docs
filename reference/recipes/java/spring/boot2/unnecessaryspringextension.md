 ...
 **org.openrewrite.java.spring.boot2.UnnecessarySpringExtension** _`@SpringBootTest` already applies `@SpringExtension` as of Spring Boot 2.1.0._
...
Recipes can also be activated directly from the commandline by adding the argument `-DactiveRecipe=org.openrewrite.java.spring.boot2.UnnecessarySpringExtension` on\`
