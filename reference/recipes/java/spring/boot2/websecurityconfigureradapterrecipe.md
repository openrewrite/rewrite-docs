...
** org.openrewrite.java.spring.boot2.WebSecurityConfigurerAdapterRecipe**
...
rewrite {
    activeRecipe("org.openrewrite.java.spring.boot2.WebSecurityConfigurerAdapterRecipe")
}
  ...
  <build>
    <plugins>
      <plugin>
        ...
        <configuration>
          <activeRecipes>
            <recipe>org.openrewrite.java.spring.boot2.WebSecurityConfigurerAdapterRecipe</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.java.spring.boot2.WebSecurityConfigurerAdapterRecipe`
