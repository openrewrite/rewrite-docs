# Delete a spring configuration property from any configuration files that contains a matching key
...
displayName: Delete a spring configuration property from any configuration files that contains a matching key example
recipeList:
  - org.openrewrite.java.spring.DeleteSpringProperty:
...
Now that `com.yourorg.DeleteSpringPropertyExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-spring:4.30.0 in your build file:
