...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.38.2:run \
  ...
  -DactiveRecipes=org.openrewrite.java.security.secrets.FindJwtSecrets
```
{% endcode %}
{% endtab %}
{% endtabs %}

Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.java.security.secrets.FindJwtSecrets`
