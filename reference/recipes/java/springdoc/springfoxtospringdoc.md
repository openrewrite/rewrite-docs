...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/springdoc.yml), [Issue Tracker](https://github.com/openrewrite/rewrite-spring/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-spring/5.19.0/jar)
...
* [Migrate from Swagger to SpringDoc and OpenAPI](../../java/springdoc/swaggertospringdoc.md)
* [Replace SpringFox Dependencies](../../java/springdoc/replacespringfoxdependencies.md)
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.java.springdoc.SpringFoxToSpringDoc)
