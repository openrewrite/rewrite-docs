...
Now that `com.yourorg.RemoveDependencyExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-java-dependencies:1.0.9 in your build file:
{% tabs %}
{% tab title="Gradle" %}
