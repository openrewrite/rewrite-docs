...
Now that `com.yourorg.ChangeDependencyExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-java-dependencies:1.16.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
