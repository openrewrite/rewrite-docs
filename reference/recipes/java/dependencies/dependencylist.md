...
Now that `com.yourorg.DependencyListExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-java-dependencies:0.4.0-SNAPSHOT in your build file:
...
dependencies {
    rewrite("org.openrewrite.recipe:rewrite-java-dependencies:0.4.0-SNAPSHOT")
}
```
{% endcode %}
{% endtab %}
