...
Now that `com.yourorg.DependencyInsightExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-java-dependencies:1.14.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
