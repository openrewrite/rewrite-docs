...
**org.openrewrite.java.SimplifyMethodChain** _Simplify `a.b().c()` to `a.d()`._
...
| -------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `List`   | methodPatternChain | A list of [method patterns](../../method-patterns.md) that are called in sequence                                                                      |
