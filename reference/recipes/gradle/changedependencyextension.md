...
Now that `com.yourorg.ChangeDependencyExtensionExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.29.0 in your build file:
