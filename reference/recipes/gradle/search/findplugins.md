...
Now that `com.yourorg.FindPluginsExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.33.0 in your build file:
