...
Now that `com.yourorg.FindDependencyExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.21.0 in your build file:
