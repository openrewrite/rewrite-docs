...
Now that `com.yourorg.UpdateGradleWrapperExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.30.0 in your build file:
