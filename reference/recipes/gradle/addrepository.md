...
Now that `com.yourorg.AddRepositoryExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.16.0 in your build file:
