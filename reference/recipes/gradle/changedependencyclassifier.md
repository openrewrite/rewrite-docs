...
Now that `com.yourorg.ChangeDependencyClassifierExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.34.3 in your build file:
