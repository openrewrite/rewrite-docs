...
Now that `com.yourorg.RemoveSettingsPluginExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.36.0-SNAPSHOT in your build file:
