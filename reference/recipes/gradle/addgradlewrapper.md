...
Now that `com.yourorg.AddGradleWrapperExample` has been defined activate it and take a dependency on org.openrewrite:rewrite-gradle:7.31.0 in your build file:
