...
[GitHub](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/resources/META-INF/rewrite/gradle-6.yml), [Issue Tracker](https://github.com/openrewrite/rewrite/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite/rewrite-gradle/8.36.0/jar)
...
* [Migrate to Gradle 5 from Gradle 4](../gradle/migratetogradle5.md)
* [Update Gradle wrapper](../gradle/updategradlewrapper.md)
  * version: `6.x`
  * addIfMissing: `false`
* [Change a Gradle dependency configuration](../gradle/changedependencyconfiguration.md)
  * groupId: `*`
  * artifactId: `*`
...
* [Remove an enabled Gradle preview feature](../gradle/removeenablefeaturepreview.md)
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.gradle.MigrateToGradle6)
