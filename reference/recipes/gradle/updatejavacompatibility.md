...
[GitHub](https://github.com/openrewrite/rewrite/blob/main/rewrite-gradle/src/main/java/org/openrewrite/gradle/UpdateJavaCompatibility.java), [Issue Tracker](https://github.com/openrewrite/rewrite/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite/rewrite-gradle/8.15.2/jar)
...
| `Boolean` | addSourceCompatibilityIfMissing | *Optional*. Adds Source Compatibility if one is not found. |  |
| `Boolean` | addTargetCompatibilityIfMissing | *Optional*. Adds Target Compatibility if one is not found. |  |
...
## Contributors
[Shannon Pamperl](mailto:shanman190@gmail.com), [Ken Little](mailto:krl49700@gmail.com), [Tim te Beek](mailto:tim@moderne.io), [Sam Snyder](mailto:sam@moderne.io), [Jonathan Schnéider](mailto:jkschneider@gmail.com)
