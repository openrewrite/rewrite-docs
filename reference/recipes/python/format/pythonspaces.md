...
[GitHub](https://github.com/openrewrite/rewrite-python/blob/main/src/main/java/org/openrewrite/python/format/PythonSpaces.java), [Issue Tracker](https://github.com/openrewrite/rewrite-python/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite/rewrite-python/1.1.2/jar)
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe org.openrewrite.python.format.PythonSpaces
```
{% endcode %}
{% endtab %}
{% endtabs %}
