...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite:rewrite-python:RELEASE -Drewrite.activeRecipes=org.openrewrite.python.cleanup.StartsWithEndsWith
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run . --recipe StartsWithEndsWith
```
{% endcode %}
{% endtab %}
{% endtabs %}
...
[![Moderne Link Image](/.gitbook/assets/ModerneRecipeButton.png)](https://app.moderne.io/recipes/org.openrewrite.python.cleanup.StartsWithEndsWith)
