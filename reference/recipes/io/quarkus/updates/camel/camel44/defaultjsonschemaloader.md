...
[GitHub](https://github.com/search?type=code&q=io.quarkus.updates.camel.camel44.DefaultJsonSchemaLoader), [Issue Tracker](https://github.com/openrewrite/rewrite-third-party/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-third-party/0.5.4/jar)
...
```shell
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.camel.camel44.DefaultJsonSchemaLoader -Drewrite.exportDatatables=true
```
{% endcode %}
{% endtab %}
