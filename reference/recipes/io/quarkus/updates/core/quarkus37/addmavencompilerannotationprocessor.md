...
[GitHub](https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus37.AddMavenCompilerAnnotationProcessor), [Issue Tracker](https://github.com/openrewrite/rewrite-third-party/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-third-party/0.7.0/jar)
...
Now that `com.yourorg.AddMavenCompilerAnnotationProcessorExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-third-party:0.7.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
