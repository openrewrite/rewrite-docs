...
Now that `com.yourorg.ChangeMavenCompilerAnnotationProcessorGroupIdAndArtifactIdExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-third-party:0.5.3 in your build file:
{% tabs %}
{% tab title="Gradle" %}
