...
Now that `com.yourorg.UseAsBuilderExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-static-analysis:1.1.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
