...
Now that `com.yourorg.UseAsBuilderExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-static-analysis:1.4.0 in your build file:
{% tabs %}
{% tab title="Gradle" %}
...
## Contributors
[Jonathan Schneider](mailto:jkschneider@gmail.com), [srmalkan](mailto:smitmalkan99@gmail.com), [Knut Wannheden](mailto:knut@moderne.io), [Tim te Beek](mailto:tim@moderne.io)
