...
Now that `com.yourorg.DeclarationSiteTypeVarianceExample` has been defined activate it and take a dependency on org.openrewrite.recipe:rewrite-static-analysis:1.10.1 in your build file:
{% tabs %}
{% tab title="Gradle" %}
