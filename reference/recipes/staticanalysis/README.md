...
* [Replace `booleanExpression ? false : true` with `!booleanExpression`](./simplifyternaryrecipessimplifyternaryfalsetruerecipe.md)
* [Replace `booleanExpression ? true : false` with `booleanExpression`](./simplifyternaryrecipessimplifyternarytruefalserecipe.md)
