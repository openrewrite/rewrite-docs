...
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run \
  ...
  -Drewrite.activeRecipes=org.openrewrite.micrometer.misk.NoExplicitEmptyLabelList
```
{% endcode %}
{% endtab %}
...
{% code title="shell" %}
```shell
mod run <PATH> --recipe NoExplicitEmptyLabelList
```
{% endcode %}
{% endtab %}
{% endtabs %}
