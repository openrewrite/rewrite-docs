 ...
 **org.openrewrite.terraform.aws.EnsureRDSDatabaseHasIAMAuthenticationEnabled** _Ensure RDS database has IAM authentication enabled._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.terraform.aws.EnsureRDSDatabaseHasIAMAuthenticationEnabled`
