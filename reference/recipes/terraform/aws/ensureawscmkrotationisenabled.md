 ...
 **org.openrewrite.terraform.aws.EnsureAWSCMKRotationIsEnabled** _Ensure AWS CMK rotation is enabled._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.terraform.aws.EnsureAWSCMKRotationIsEnabled`
