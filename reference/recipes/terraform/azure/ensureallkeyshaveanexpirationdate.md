...
mvn org.openrewrite.maven:rewrite-maven-plugin:4.36.0:run \
  ...
  -DactiveRecipes=org.openrewrite.terraform.azure.EnsureAllKeysHaveAnExpirationDate
```
{% endcode %}
{% endtab %}
{% endtabs %}

Recipes can also be activated directly from the command line by adding the argument `-Drewrite.activeRecipes=org.openrewrite.terraform.azure.EnsureAllKeysHaveAnExpirationDate`
