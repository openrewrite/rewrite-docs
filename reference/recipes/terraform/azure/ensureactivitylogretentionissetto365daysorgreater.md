 ...
 **org.openrewrite.terraform.azure.EnsureActivityLogRetentionIsSetTo365DaysOrGreater** _Ensure activity log retention is set to 365 days or greater._
...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.terraform.azure.EnsureActivityLogRetentionIsSetTo365DaysOrGreater`
