...
Recipes can also be activated directly from the command line by adding the argument `-DactiveRecipe=org.openrewrite.terraform.azure.EnsureAzureSQLServerAuditLogRetentionIsGreaterThan90Days`
...
* [Add Terraform configuration](../addconfiguration.md)
  ...
  * content: \`extended\_auditing\_policy {
