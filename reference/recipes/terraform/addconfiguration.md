...
[GitHub](https://github.com/openrewrite/rewrite-terraform/blob/main/src/main/java/org/openrewrite/terraform/AddConfiguration.java), [Issue Tracker](https://github.com/openrewrite/rewrite-terraform/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-terraform/2.3.9/jar)
...
Now that `com.yourorg.AddConfigurationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-terraform:2.3.9 in your build file:
{% tabs %}
{% tab title="Gradle" %}
