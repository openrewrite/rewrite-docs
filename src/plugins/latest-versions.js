const latestVersions = {
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_CORE}}": "8.48.0",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_JAVA}}": "8.48.0",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROPERTIES}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROTOBUF}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PYTHON}}": "1.33.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TEMPLATING}}": "1.24.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TOML}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_XML}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_YAML}}": "8.48.0",
