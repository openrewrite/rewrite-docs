const latestVersions = {
  ...
  "{{VERSION_REWRITE_GRADLE_PLUGIN}}": "7.1.6",
  "{{VERSION_REWRITE_MAVEN_PLUGIN}}": "6.2.1",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_CORE}}": "8.47.2",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_JAVA}}": "8.47.2",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROPERTIES}}": "8.47.2",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROTOBUF}}": "8.47.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PYTHON}}": "1.32.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TEMPLATING}}": "1.23.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TOML}}": "8.47.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_XML}}": "8.47.2",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_YAML}}": "8.47.2",
