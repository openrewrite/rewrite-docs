const latestVersions = {
  ...
  "{{VERSION_REWRITE_GRADLE_PLUGIN}}": "7.2.1",
  "{{VERSION_REWRITE_MAVEN_PLUGIN}}": "6.3.2",
  ...
  "{{VERSION_ORG_OPENREWRITE_REWRITE_CORE}}": "8.48.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_CSHARP}}": "0.23.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_GRADLE}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_GROOVY}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_HCL}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_JAVA}}": "8.48.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_JAVASCRIPT}}": "0.33.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_JSON}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_KOTLIN}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_MAVEN}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_POLYGLOT}}": "2.1.3",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROPERTIES}}": "8.48.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PROTOBUF}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_PYTHON}}": "1.33.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TEMPLATING}}": "1.24.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_TOML}}": "8.48.0",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_XML}}": "8.48.1",
  "{{VERSION_ORG_OPENREWRITE_REWRITE_YAML}}": "8.48.1",
