...
See various ways you can configure your project to run this recipe on the [recipe reference page](/reference/recipes/java/spring/boot3/upgradespringboot_3_2.md). This is also where you can find the full list of changes it will make.
