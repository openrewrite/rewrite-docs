...
1. You will need to ensure your project is built with Maven as only the [rewrite-maven-plugin](https://github.com/openrewrite/rewrite-maven-plugin) (version `5.32.1` or higher) currently supports this feature. 
...
<plugin>
    ...
    <version>5.32.1-SNAPSHOT</version>
    <configuration>
