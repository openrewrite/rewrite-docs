...
### Step 2: Add the Rewrite Maven Plugin
...
This maven plugin comes with a default set of recipes that can be activated at will. In this case, we're activating the `org.openrewrite.java.Spring` and `org.openrewrite.java.Mockito` recipes.
