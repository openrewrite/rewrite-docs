...
[GitHub](https://github.com/openrewrite/rewrite/blob/main/rewrite-json/src/main/java/org/openrewrite/json/ChangeKey.java), 
...
Jonathan Schneider, Tim te Beek, Aaron Gershman, Mike Solomon, Sam Snyder
