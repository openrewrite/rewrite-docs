...
[GitHub](https://github.com/openrewrite/rewrite/blob/main/rewrite-yaml/src/main/java/org/openrewrite/yaml/ChangeKey.java), [Issue Tracker](https://github.com/openrewrite/rewrite/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite/rewrite-yaml/8.38.0/jar)
...
<a href="https://app.moderne.io/recipes/org.openrewrite.yaml.ChangeKey">
    <img
...
## Contributors
[Jonathan Schneider](mailto:jkschneider@gmail.com), Aaron Gershman, [Tim te Beek](mailto:tim@moderne.io), [Mike Solomon](mailto:mike@moderne.io), Patrick Way, [Sam Snyder](mailto:sam@moderne.io)
