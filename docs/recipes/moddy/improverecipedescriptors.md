---
sidebar_label: "Improve recipe descriptors"
---
...
_Improving recipe display names and descriptions in turn improves Moddy._
...
```shell title="shell"
mod run . --recipe ImproveRecipeDescriptors
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.moddy.ImproveRecipeDescriptors" />
