...
description: Require or disallow spacing between function identifiers and their invocations –  – See [rule details](https://eslint.style/rules/default/function-call-spacing) – 
tags:
  - eslint
  - stylistic
recipeList:
