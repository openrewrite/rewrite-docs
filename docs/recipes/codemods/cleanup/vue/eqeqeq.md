...
description: Require the use of === and !== in `<template>` – See rule details for [vue/eqeqeq](https://eslint.vuejs.org/rules/eqeqeq.html) – 
tags:
  - ESLint
  - vue
  - eslint-plugin-vue
...
<a href="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.Eqeqeq">
    <img
