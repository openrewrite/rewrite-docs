...
description: Disallow unnecessary parentheses in `<template>` – See rule details for [vue/no-extra-parens](https://eslint.vuejs.org/rules/no-extra-parens.html) – 
tags:
  - ESLint
  - vue
  - eslint-plugin-vue
...
<a href="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.NoExtraParens">
    <img
