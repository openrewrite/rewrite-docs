...
description: Require or disallow method and property shorthand syntax for object literals in `<template>` – See rule details for [vue/object-shorthand](https://eslint.vuejs.org/rules/object-shorthand.html) – 
tags:
  - ESLint
  - vue
  - eslint-plugin-vue
...
<a href="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.vue.ObjectShorthand">
    <img
