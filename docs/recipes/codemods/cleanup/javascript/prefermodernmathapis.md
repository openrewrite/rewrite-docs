...
description: Prefer modern Math APIs over legacy patterns. – See [rule details](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/prefer-modern-math-apis.md) – 
recipeList:
