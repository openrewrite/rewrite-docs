...
description: Disallow `if` statements as the only statement in `if` blocks without `else`. – See [rule details](https://github.com/sindresorhus/eslint-plugin-unicorn/blob/main/docs/rules/no-lonely-if.md) – 
recipeList:
