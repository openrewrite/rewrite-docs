...
description: A story should not have a redundant name property – See rule details for [storybook/no-redundant-story-name](https://github.com/storybookjs/eslint-plugin-storybook/blob/main/docs/rules/no-redundant-story-name.md) – 
tags:
  - eslint-plugin-storybook
  - ESLint
  - storybook
...
<a href="https://app.moderne.io/recipes/org.openrewrite.codemods.cleanup.storybook.NoRedundantStoryName">
    <img
