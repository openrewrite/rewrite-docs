...
* [Recommended svelte code cleanup](./recommendedsveltecodecleanup.md)
* [disallow dynamic slot name](./nodynamicslotname.md)
* [disallow spaces around equal signs in attribute](./nospacesaroundequalsignsinattribute.md)
...
* [enforce the location of first attribute](./firstattributelinebreak.md)
* [enforce the maximum number of attributes per line](./maxattributesperline.md)
* [enforce unified spacing in mustache](./mustachespacing.md)
