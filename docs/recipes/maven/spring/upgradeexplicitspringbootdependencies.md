...
Now that `com.yourorg.UpgradeExplicitSpringBootDependenciesExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-spring:5.22.0 in your build file:
