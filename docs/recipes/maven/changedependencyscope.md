...
* [Change the jakarta.inject-api dependency to scope provided when jakartaee-api 9.x is provided.](/recipes/oracle/weblogic/rewrite/changejakartainjectapidependencyscope.md)
* [Change the jakarta.ws.rs-api dependency to scope provided when jakartaee-api 9.x is provided.](/recipes/oracle/weblogic/rewrite/changejakartawebservicersapidependencyscope.md)
* [Change the jakarta.xml.bind-api dependency to scope provided when jakartaee-api 9.x is provided.](/recipes/oracle/weblogic/rewrite/changejaxbbindapidependencyscope.md)
