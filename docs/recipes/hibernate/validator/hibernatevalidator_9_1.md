...
**org.openrewrite.hibernate.validator.HibernateValidator\_9\_1**

_This recipe will apply changes commonly needed when migrating to Hibernate Validator 9.1.x._
...
* [Migrate to Hibernate Validator 8.0.x](../../hibernate/validator/hibernatevalidator_8_0)
* [Move `@Valid` from the container to its element type](../../hibernate/validator/movevalidtocontainerelement)
...
## Examples
##### Example 1
`HibernateValidator91Test#upgradeDependencyAndMoveValidInward`
...
<RunRecipe
  recipeName="org.openrewrite.hibernate.validator.HibernateValidator_9_1"
  displayName="Migrate to Hibernate Validator 9.1.x"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.hibernate.validator.HibernateValidator_9_1" />
