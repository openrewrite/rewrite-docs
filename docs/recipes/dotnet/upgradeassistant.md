...
[GitHub](https://github.com/openrewrite/rewrite-dotnet/blob/main/src/main/java/org/openrewrite/dotnet/UpgradeAssistant.java), [Issue Tracker](https://github.com/openrewrite/rewrite-dotnet/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-dotnet/0.5.0/jar)
...
Now that `com.yourorg.UpgradeAssistantExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-dotnet:0.5.0 in your build file:
...
dependencies {
    rewrite("org.openrewrite.recipe:rewrite-dotnet:0.5.0")
}
```
...
```shell
mod config recipes jar install org.openrewrite.recipe:rewrite-dotnet:0.5.0
```
</TabItem>
</Tabs>
