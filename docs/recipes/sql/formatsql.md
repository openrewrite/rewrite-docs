...
[GitHub](https://github.com/openrewrite/rewrite-sql/blob/main/src/main/java/org/openrewrite/sql/FormatSql.java), [Issue Tracker](https://github.com/openrewrite/rewrite-sql/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-sql/1.10.0/jar)
...
This recipe has no required configuration options. It can be activated by adding a dependency on `org.openrewrite.recipe:rewrite-sql:1.10.0` in your build file or by running a shell command (in which case no build changes are needed): 
...
<TabItem value="gradle" title="Gradle">
    ...
    dependencies {
        rewrite("org.openrewrite.recipe:rewrite-sql:1.10.0")
    }
    ```
