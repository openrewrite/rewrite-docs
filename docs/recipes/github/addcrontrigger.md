...
Now that `com.yourorg.AddCronTriggerExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.8.2 in your build file:
