...
Now that `com.yourorg.ChangeActionExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.10.0 in your build file:
...
dependencies {
    rewrite("org.openrewrite.recipe:rewrite-github-actions:2.10.0")
}
```
...
```shell
mod config recipes jar install org.openrewrite.recipe:rewrite-github-actions:2.10.0
```
</TabItem>
</Tabs>
