...
Now that `com.yourorg.ChangeActionExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-github-actions:2.10.1 in your build file:
...
dependencies {
    rewrite("org.openrewrite.recipe:rewrite-github-actions:2.10.1")
}
```
...
```shell
mod config recipes jar install org.openrewrite.recipe:rewrite-github-actions:2.10.1
```
</TabItem>
</Tabs>
