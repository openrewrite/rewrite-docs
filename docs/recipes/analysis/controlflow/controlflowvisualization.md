...
Now that `com.yourorg.ControlFlowVisualizationExample` has been defined, activate it and take a dependency on org.openrewrite.meta:rewrite-analysis:2.13.0 in your build file:
