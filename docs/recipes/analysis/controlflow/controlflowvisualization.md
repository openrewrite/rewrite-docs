...
Now that `com.yourorg.ControlFlowVisualizationExample` has been defined, activate it and take a dependency on org.openrewrite.meta:rewrite-analysis:2.11.0 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.analysis.controlflow.ControlFlowVisualization">
    <img
