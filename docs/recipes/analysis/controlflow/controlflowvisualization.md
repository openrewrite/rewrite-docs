...
Now that `com.yourorg.ControlFlowVisualizationExample` has been defined, activate it and take a dependency on org.openrewrite.meta:rewrite-analysis:2.11.2 in your build file:
