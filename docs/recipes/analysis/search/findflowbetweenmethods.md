...
Now that `com.yourorg.FindFlowBetweenMethodsExample` has been defined, activate it and take a dependency on org.openrewrite.meta:rewrite-analysis:2.13.1 in your build file:
