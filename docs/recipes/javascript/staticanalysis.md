---
sidebar_label: "JavaScript Common static analysis issues"
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# JavaScript Common static analysis issues

**org.openrewrite.javascript.StaticAnalysis**

_Static analysis fixes for JavaScript sources._
...
name: org.openrewrite.javascript.StaticAnalysis
displayName: JavaScript Common static analysis issues
description: |
  Static analysis fixes for JavaScript sources.
recipeList:
...
rewrite {
    activeRecipe("org.openrewrite.javascript.StaticAnalysis")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.javascript.StaticAnalysis</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite:rewrite-javascript:RELEASE -Drewrite.activeRecipes=org.openrewrite.javascript.StaticAnalysis -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.javascript.StaticAnalysis" />
