...
rewrite {
    activeRecipe("org.openrewrite.java.joda.time.JodaAbstractInstantToJavaTime")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.joda.time.JodaAbstractInstantToJavaTime</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-joda:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.joda.time.JodaAbstractInstantToJavaTime -Drewrite.exportDatatables=true
```
</TabItem>
