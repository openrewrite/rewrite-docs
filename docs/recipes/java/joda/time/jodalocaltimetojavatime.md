...
rewrite {
    activeRecipe("org.openrewrite.java.joda.time.JodaLocalTimeToJavaTime")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.joda.time.JodaLocalTimeToJavaTime</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-joda:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.joda.time.JodaLocalTimeToJavaTime -Drewrite.exportDatatables=true
```
</TabItem>
