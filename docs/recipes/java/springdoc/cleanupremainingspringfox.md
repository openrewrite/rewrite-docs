...
rewrite {
    activeRecipe("org.openrewrite.java.springdoc.CleanupRemainingSpringfox")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.springdoc.CleanupRemainingSpringfox</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.springdoc.CleanupRemainingSpringfox -Drewrite.exportDatatables=true
```
</TabItem>
