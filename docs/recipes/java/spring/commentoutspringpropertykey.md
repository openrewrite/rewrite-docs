...
* [Migrate Spring Boot properties to 4.1 (Moderne Edition)](https://docs.moderne.io/user-documentation/recipes/recipe-catalog/java/spring/boot4/springbootproperties_4_1-moderne-edition)
