...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/META-INF/rewrite/spring-security-62.yml), 
...
Simon Verhoeven, Laurens Westerlaken, Nick McKinney, Tim te Beek
