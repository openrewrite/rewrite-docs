...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/security6/ApplyToWithLambdaDsl.java), 
...
Nick McKinney, Jonathan Schnéider, Tim te Beek
