...
_Adds the dedicated Spring Boot 4.0 reactive Spring Data MongoDB test starter when the application directly uses the reactive Spring Data MongoDB starter and MongoDB test slices._
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.boot4.AddSpringBootStarterDataMongoDbReactiveTest"
  displayName="Add `spring-boot-starter-data-mongodb-reactive-test` for reactive MongoDB tests"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.boot4.AddSpringBootStarterDataMongoDbReactiveTest" />
