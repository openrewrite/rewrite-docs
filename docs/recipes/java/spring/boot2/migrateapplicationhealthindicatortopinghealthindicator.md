...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot2/MigrateApplicationHealthIndicatorToPingHealthIndicator.java),
