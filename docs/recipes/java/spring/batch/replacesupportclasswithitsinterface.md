...
Now that `com.yourorg.ReplaceSupportClassWithItsInterfaceExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-spring:5.22.0 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.spring.batch.ReplaceSupportClassWithItsInterface">
    <img
