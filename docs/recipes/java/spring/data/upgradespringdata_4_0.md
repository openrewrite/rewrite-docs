...
**org.openrewrite.java.spring.data.UpgradeSpringData\_4\_0**

_Migrate applications to the Spring Data 2025.1 release train. Datastore-specific migration support is added incrementally._
...
* [Migrate to Spring Data MongoDB 5.0](../../../java/spring/data/upgradespringdatamongodb_5_0)
...
<RunRecipe
  recipeName="org.openrewrite.java.spring.data.UpgradeSpringData_4_0"
  displayName="Migrate to Spring Data 4.0"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.spring.data.UpgradeSpringData_4_0" />
