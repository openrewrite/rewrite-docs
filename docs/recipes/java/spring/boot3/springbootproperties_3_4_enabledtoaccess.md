...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot3/SpringBootProperties_3_4_EnabledToAccess.java),
