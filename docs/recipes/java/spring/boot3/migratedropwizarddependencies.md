...
* [dropwizard](/reference/recipes-by-tag#dropwizard)

## Recipe source

[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/boot3/MigrateDropWizardDependencies.java),
