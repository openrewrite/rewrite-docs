...
[GitHub](https://github.com/openrewrite/rewrite-spring/blob/main/src/main/java/org/openrewrite/java/spring/framework/MigrateUriComponentsBuilderMethods.java), 
...
## Contributors
Cathy, [JohannisK](mailto:johan.kragt@moderne.io)
