...
rewrite {
    activeRecipe("org.openrewrite.java.jackson.StdDeserializerNullConstructor")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.jackson.StdDeserializerNullConstructor</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-jackson:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.jackson.StdDeserializerNullConstructor -Drewrite.exportDatatables=true
```
</TabItem>
