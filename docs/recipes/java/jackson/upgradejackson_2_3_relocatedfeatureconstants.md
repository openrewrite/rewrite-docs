...
rewrite {
    activeRecipe("org.openrewrite.java.jackson.UpgradeJackson_2_3_RelocatedFeatureConstants")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.jackson.UpgradeJackson_2_3_RelocatedFeatureConstants</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-jackson:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.jackson.UpgradeJackson_2_3_RelocatedFeatureConstants -Drewrite.exportDatatables=true
```
</TabItem>
