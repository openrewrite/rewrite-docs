...
rewrite {
    activeRecipe("org.openrewrite.java.jackson.AddJsonCreatorToPrivateConstructors")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.jackson.AddJsonCreatorToPrivateConstructors</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-jackson:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.jackson.AddJsonCreatorToPrivateConstructors -Drewrite.exportDatatables=true
```
</TabItem>
