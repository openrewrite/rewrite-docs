...
Now that `com.yourorg.ExplicitContainerImageExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-testing-frameworks:2.22.0 in your build file:
