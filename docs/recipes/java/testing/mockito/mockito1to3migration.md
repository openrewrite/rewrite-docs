...
* [Retain Mockito strictness `WARN` when switching to JUnit 5](../../../java/testing/mockito/retainstrictnesswarn)
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.testing.mockito.Mockito1to3Migration">
    <img
