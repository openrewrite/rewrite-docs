...
* [Replace PowerMock `Whitebox.getField()` with Java reflection](./powermockwhiteboxgetfieldtojavareflection.md)
* [Replace PowerMock `Whitebox.getInternalState()` with Java reflection](./powermockwhiteboxgetinternalstatetojavareflection.md)
* [Replace PowerMock `Whitebox.getMethod()` with Java reflection](./powermockwhiteboxgetmethodtojavareflection.md)
* [Replace PowerMock `Whitebox.invokeConstructor()` with Java reflection](./powermockwhiteboxinvokeconstructortojavareflection.md)
