...
rewrite {
    activeRecipe("org.openrewrite.java.testing.junit5.CleanupKotlinJUnit5AssertionImports")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.testing.junit5.CleanupKotlinJUnit5AssertionImports</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-testing-frameworks:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.testing.junit5.CleanupKotlinJUnit5AssertionImports -Drewrite.exportDatatables=true
```
</TabItem>
