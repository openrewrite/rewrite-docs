...
_Convert TestNG-style hard assertions on `org.testng.asserts.Assertion` instances to static AssertJ `assertThat(...)`, removing the now-unused local `Assertion` instance._

## Recipe source

[GitHub: TestNgAssertionToAssertJ.java](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/testng/TestNgAssertionToAssertJ.java),
...
<RunRecipe
  recipeName="org.openrewrite.java.testing.testng.TestNgAssertionToAssertJ"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.java.testing.testng.TestNgAssertionToAssertJ" />
