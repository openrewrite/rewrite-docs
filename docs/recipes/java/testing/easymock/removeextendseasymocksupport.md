...
[GitHub](https://github.com/openrewrite/rewrite-testing-frameworks/blob/main/src/main/java/org/openrewrite/java/testing/easymock/RemoveExtendsEasyMockSupport.java), 
...
Jacob van Lingen, Jonathan Schnéider
