...
Now that `com.yourorg.UpgradeMicronautMavenPropertyVersionExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-micronaut:2.10.0 in your build file:
...
```shell title="shell"
mod run . --recipe UpgradeMicronautMavenPropertyVersionExample
```
</TabItem>
</Tabs>
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.micronaut.UpgradeMicronautMavenPropertyVersion">
    <img
