...
rewrite {
    activeRecipe("org.openrewrite.java.search.ModuleContainsFile")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.search.ModuleContainsFile</recipe>
          </activeRecipes>
        </configuration>
      </plugin>
    </plugins>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.activeRecipes=org.openrewrite.java.search.ModuleContainsFile -Drewrite.exportDatatables=true
```
