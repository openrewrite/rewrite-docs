...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.jetty.MigrateJettyHandlerSignature")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.jetty.MigrateJettyHandlerSignature</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.jetty.MigrateJettyHandlerSignature -Drewrite.exportDatatables=true
```
</TabItem>
