...
rewrite {
    activeRecipe("org.openrewrite.java.dropwizard.test.MockitoVariableToMockBean")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.dropwizard.test.MockitoVariableToMockBean</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-dropwizard:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.dropwizard.test.MockitoVariableToMockBean -Drewrite.exportDatatables=true
```
</TabItem>
