...
Now that `com.yourorg.ChangeLogLevelExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-logging-frameworks:2.15.1 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.logging.slf4j.ChangeLogLevel">
    <img
