...
Now that `com.yourorg.ChangeLogLevelExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-logging-frameworks:2.17.0 in your build file:
