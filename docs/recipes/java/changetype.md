...
* [Migrate StubRunner JUnit 4 Rule to JUnit 5 Extension](/recipes/sh/stubborn/contract/migration/dropjunit4support.md)
...
* [Migrate `io.cucumber.java8.Scenario` and `io.cucumber.java8.Status`](/recipes/cucumber/jvm/migratecucumberjava8scenarioandstatus.md)
