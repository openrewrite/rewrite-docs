...
* [Apply Axon Framework 5 event-sourcing module renames](/recipes/axonframework/migration/axon4toaxon5eventsourcing.md)
...
* [Apply Axon Framework 5 test module renames](/recipes/axonframework/migration/axon4toaxon5test.md)
* [AssertJ best practices](/recipes/java/testing/assertj/assertj-best-practices.md)
* [Change SDK Exception types from v1 to v2](/recipes/amazon/awssdk/v2migration/changeexceptiontypes.md)
* [Change SDK S3EventNotification types from v1 to v2](/recipes/amazon/awssdk/v2migration/changes3eventnotificationtypes.md)
...
* [MemoryStateRepository and FileStateRepository were moved to another package and library](/recipes/apache/camel/upgrade/camel43/staterepository.md)
...
* [Migrate Hibernate dialect to the generic dialect](/recipes/hibernate/migratedialect.md)
...
* [Migrate JUnit 4 assertion failure exceptions to JUnit Jupiter](/recipes/java/testing/junit5/migrateassertionfailederror.md)
* [Migrate JUnit Pioneer extensions to native JUnit Jupiter equivalents](/recipes/java/testing/junit6/migratejunitpioneertojupiter.md)
...
* [Migrate Spring @Transactional to Jakarta @Transactional](/recipes/quarkus/spring/migratespringtransactional.md)
...
* [Migrate deprecated `javax.annotation.sql` packages to `jakarta.annotation.sql`](/recipes/quarkus/updates/core/quarkus30/javaxannotationsqlpackagetojakarta.md)
* [Migrate deprecated `javax.annotation` packages to `jakarta.annotation`](/recipes/quarkus/updates/core/quarkus30/javaxannotationpackagetojakarta.md)
...
* [Migrate distributed messaging components to Axoniq Framework 5](/recipes/axoniq/framework/migration/axon4toaxoniq5distributedmessaging.md)
...
* [Migrate from `@Api` to `@Tag`](/recipes/openapi/swagger/migrateapitotag.md)
...
* [Migrate the Axon Server Testcontainer to Axoniq Framework 5](/recipes/axoniq/framework/migration/axon4toaxoniq5testcontainer.md)
...
* [Migrate to Apache Kafka Native container](/recipes/java/testing/testcontainers/migratetokafkanative.md)
...
* [Migrates `camel 4.17` application to `camel 4.18`](/recipes/apache/camel/upgrade/camel418/camelmigrationrecipe.md)
...
* [Renamed BasicAuthenticationHttpClientConfigurer to  DefaultAuthenticationHttpClientConfigurer](/recipes/apache/camel/upgrade/camel413/furyjava.md)
* [Renamed classes for API](/recipes/apache/camel/upgrade/camel47/renamedclasses.md)
* [Renamed classes for elasticsearch,opensearch and spring regis](/recipes/apache/camel/upgrade/camel45/renamedclasses.md)
* [Renamed classes for elasticsearch,opensearch and spring regis](/recipes/apache/camel/upgrade/camel46/renamedclasses.md)
* [Renamed constants in camel-azure-files](/recipes/apache/camel/upgrade/camel410/camelazurefiles.md)
* [Replace  deprecated Jakarta Servlet methods and classes](/recipes/java/migrate/jakarta/removalsservletjakarta10.md)
* [Replace Removed WebLogicJtaTransactionManager from Spring Framework 5.3.x to 6.2.x](/recipes/oracle/weblogic/rewrite/spring/framework/replaceweblogicjtatransactionmanager.md)
* [Replace Removed WebLogicLoadTimeWeaver from Spring Framework 5.3.x to 6.2.x](/recipes/oracle/weblogic/rewrite/spring/framework/replaceweblogicloadtimeweaver.md)
...
* [Replace `ResourceResolver` with `ResourceHandler`](/recipes/oracle/weblogic/rewrite/jakarta/removedjakartafaces3resourceresolver.md)
...
* [Replace deprecated DefaultJsonSchemaLoader with DefaultJsonUriSchemaLoader](/recipes/apache/camel/upgrade/camel44/defaultjsonschemaloader.md)
...
* [Tag Enum has been deprecated](/recipes/apache/camel/upgrade/camel41/tracingtag.md)
* [Testcontainers 2 container classes](/recipes/java/testing/testcontainers/testcontainers2containerclasses.md)
* [The package scan classes has moved from camel-base-engine to camel-support - java](/recipes/apache/camel/upgrade/camel412/scanclassesmoved.md)
...
* [Use PlatformHttpHeaderFilterStrategy instead of HttpHeaderFilterStrategy](/recipes/apache/camel/upgrade/camel411/platformhttpfilterstrategy.md)
...
* [Use `StateManagementStrategy`](/recipes/oracle/weblogic/rewrite/jakarta/removedstatemanagermethods3.md)
...
* [Use `jakarta.el` instead of `jakarta.faces.el` and `javax.faces.el`](/recipes/oracle/weblogic/rewrite/jakarta/removedjakartafaces3expressionlanguageclasses.md)
...
* [io.quarkus.updates.core.quarkus319.MoveAccessTokenAnnotationToNewPackage](/recipes/quarkus/updates/core/quarkus319/moveaccesstokenannotationtonewpackage.md)
* [io.quarkus.updates.core.quarkus32.InjectMock](/recipes/quarkus/updates/core/quarkus32/injectmock.md)
* [io.quarkus.updates.core.quarkus321.TlsRegistrySplitPackagesFix](/recipes/quarkus/updates/core/quarkus321/tlsregistrysplitpackagesfix.md)
* [io.quarkus.updates.core.quarkus324.MigrateFromDefaultUniqueDelegate](/recipes/quarkus/updates/core/quarkus324/migratefromdefaultuniquedelegate.md)
