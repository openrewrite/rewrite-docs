...
Now that `com.yourorg.RemoveMethodInvocationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.26.0 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.migrate.RemoveMethodInvocation">
    <img
