...
[GitHub](https://github.com/openrewrite/rewrite-migrate-java/blob/main/src/main/java/org/openrewrite/java/migrate/concurrent/MigrateAtomicReferenceArrayWeakCompareAndSetToWeakCompareAndSetPlain.java),
