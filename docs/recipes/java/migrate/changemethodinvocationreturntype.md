...
Now that `com.yourorg.ChangeMethodInvocationReturnTypeExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.26.1 in your build file:
...
```shell title="shell"
mod run . --recipe ChangeMethodInvocationReturnTypeExample
```
</TabItem>
</Tabs>
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.migrate.ChangeMethodInvocationReturnType">
    <img
