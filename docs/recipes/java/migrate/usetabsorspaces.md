...
Now that `com.yourorg.UseTabsOrSpacesExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-migrate-java:2.30.0 in your build file:
