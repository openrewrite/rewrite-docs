...
* [`Preconditions.checkNotNull` with message to `Objects.requireNonNull`](../../../java/migrate/guava/noguavarefasterrecipes$preconditionschecknotnullwithmessagetoobjectsrequirenonnullrecipe)
* [`String.valueof(String)` to `String`](../../../java/migrate/guava/noguavarefasterrecipes$stringvalueofstringrecipe)
...
<a href="https://app.moderne.io/recipes/org.openrewrite.java.migrate.guava.NoGuavaRefasterRecipes">
    <img
