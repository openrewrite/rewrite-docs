...
* [Prefer `List.copyOf(..)` in Java 10 or higher](./noguavaimmutablelistcopyof.md)
* [Prefer `List.of(..)` in Java 9 or higher](./noguavaimmutablelistof.md)
* [Prefer `Long#compare`](./preferlongcompare.md)
* [Prefer `Long#parseUnsignedLong`](./preferlongparseunsignedlong.md)
* [Prefer `Map.copyOf(..)` in Java 10 or higher](./noguavaimmutablemapcopyof.md)
...
* [Prefer `Set.copyOf(..)` in Java 10 or higher](./noguavaimmutablesetcopyof.md)
