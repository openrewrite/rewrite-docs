...
rewrite {
    activeRecipe("org.openrewrite.java.migrate.datanucleus.UpgradeDataNucleus_4_0")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.java.migrate.datanucleus.UpgradeDataNucleus_4_0</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-migrate-java:RELEASE -Drewrite.activeRecipes=org.openrewrite.java.migrate.datanucleus.UpgradeDataNucleus_4_0 -Drewrite.exportDatatables=true
```
</TabItem>
