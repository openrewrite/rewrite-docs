...
Now that `com.yourorg.DependencyLicenseCheckExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-java-dependencies:1.21.0 in your build file:
