...
[GitHub: FindExternalServiceCalls.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/io/moderne/prethink/FindExternalServiceCalls.java),
...
rewrite {
    activeRecipe("io.moderne.prethink.FindExternalServiceCalls")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.FindExternalServiceCalls</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.FindExternalServiceCalls -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindExternalServiceCalls" />
...
<TabItem value="io.moderne.prethink.table.ExternalServiceCalls" label="ExternalServiceCalls">

### External service calls
**io.moderne.prethink.table.ExternalServiceCalls**
