...
[GitHub: FindServiceEndpoints.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/io/moderne/prethink/FindServiceEndpoints.java),
...
rewrite {
    activeRecipe("io.moderne.prethink.FindServiceEndpoints")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.FindServiceEndpoints</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.FindServiceEndpoints -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindServiceEndpoints" />
...
<TabItem value="io.moderne.prethink.table.ServiceEndpoints" label="ServiceEndpoints">
...
| Service name | A human-readable name for the service derived from the class name. |
