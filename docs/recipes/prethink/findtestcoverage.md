...
_Mapping of test methods to the implementation methods they test._

| Column Name | Description |
| ----------- | ----------- |
| Test source path | The path to the test source file. |
| Test class | The fully qualified name of the test class. |
| Test method | The signature of the test method. |
| Implementation source path | The path to the implementation source file being tested. |
| Implementation class | The fully qualified name of the implementation class being tested. |
...
| Test checksum | Hash of the test method code for cache invalidation. |
