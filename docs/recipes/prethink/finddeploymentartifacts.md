...
[GitHub: FindDeploymentArtifacts.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/io/moderne/prethink/FindDeploymentArtifacts.java),
...
rewrite {
    activeRecipe("io.moderne.prethink.FindDeploymentArtifacts")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.FindDeploymentArtifacts</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.FindDeploymentArtifacts -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindDeploymentArtifacts" />
...
<TabItem value="io.moderne.prethink.table.DeploymentArtifacts" label="DeploymentArtifacts">

### Deployment artifacts
**io.moderne.prethink.table.DeploymentArtifacts**
