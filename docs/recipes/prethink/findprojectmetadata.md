...
[GitHub: FindProjectMetadata.java](https://github.com/openrewrite/rewrite-prethink/blob/main/src/main/java/io/moderne/prethink/FindProjectMetadata.java),
...
rewrite {
    activeRecipe("io.moderne.prethink.FindProjectMetadata")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.moderne.prethink.FindProjectMetadata</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-prethink:RELEASE -Drewrite.activeRecipes=io.moderne.prethink.FindProjectMetadata -Drewrite.exportDatatables=true
```
</TabItem>
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.prethink.FindProjectMetadata" />
...
<TabItem value="io.moderne.prethink.table.ProjectMetadata" label="ProjectMetadata">

### Project metadata
**io.moderne.prethink.table.ProjectMetadata**
