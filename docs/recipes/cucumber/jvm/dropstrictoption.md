...
_Cucumber-JVM 7.0.0 removed the `strict` option, as scenarios are now always executed in strict mode._
...
* [Remove annotation attribute](../../java/removeannotationattribute)
  * annotationType: `io.cucumber.junit.CucumberOptions`
  * attributeName: `strict`
* [Remove annotation attribute](../../java/removeannotationattribute)
  * annotationType: `io.cucumber.testng.CucumberOptions`
  * attributeName: `strict`
* [Delete property by key](../../properties/deleteproperty)
  * propertyKey: `cucumber.execution.strict`
...
<RunRecipe
  recipeName="org.openrewrite.cucumber.jvm.DropStrictOption"
  displayName="Drop the `strict` option"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.DropStrictOption" />
