...
_Cucumber-JVM 7.0.0 dropped `RuntimeOptionsBuilder.addDefaultFormatterIfAbsent()`, as no formatter is added implicitly any more, and renamed `addDefaultSummaryPrinterIfAbsent()` to `addDefaultSummaryPrinterIfNotDisabled()`, which defers to the new `setNoSummary()`. Mirrors the change Cucumber-JVM made to its own `io.cucumber.core.cli.Main`, which projects that run Cucumber programmatically tend to have copied._
...
* [Remove method invocations](../../java/removemethodinvocations)
  * methodPattern: `io.cucumber.core.options.RuntimeOptionsBuilder addDefaultFormatterIfAbsent()`
* [Change method name](../../java/changemethodname)
  * methodPattern: `io.cucumber.core.options.RuntimeOptionsBuilder addDefaultSummaryPrinterIfAbsent()`
  * newMethodName: `addDefaultSummaryPrinterIfNotDisabled`
...
## Examples
##### Example 1
`MigrateRuntimeOptionsBuilderTest#migrateDefaultsInBuilderChain`
...
<RunRecipe
  recipeName="org.openrewrite.cucumber.jvm.MigrateRuntimeOptionsBuilder"
  displayName="Migrate `RuntimeOptionsBuilder`"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.MigrateRuntimeOptionsBuilder" />
