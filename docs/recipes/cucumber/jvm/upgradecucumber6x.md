...
_Upgrade to Cucumber-JVM 6.x from any previous version._
...
* [Migrate `Scenario.write` and `Scenario.embed`](../../cucumber/jvm/migratescenariowriteandembed)
* [Collapse `@CucumberOptions` tags into a single tag expression](../../cucumber/jvm/collapsecucumberoptionstags)
* [Migrate the `cucumber.options` property](../../cucumber/jvm/cucumberoptionspropertytoindividualproperties)
...
<RunRecipe
  recipeName="org.openrewrite.cucumber.jvm.UpgradeCucumber6x"
  displayName="Upgrade to Cucumber-JVM 6.x"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.UpgradeCucumber6x" />
