...
_Replace `LambdaGlue` hook definitions with new annotated methods with the same body, or, for a method reference, with a body calling the method it refers to._
