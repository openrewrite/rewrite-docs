...
_Cucumber-JVM 7.0.0 removed the incorrect ISO 639-1 code `tl` for Telugu, which is now consistently `te`._
...
* [Rename package name](../../java/changepackage)
  * oldPackageName: `io.cucumber.java.tl`
  * newPackageName: `io.cucumber.java.te`
* [Change type](../../java/changetype)
  * oldFullyQualifiedTypeName: `io.cucumber.java8.Tl`
  * newFullyQualifiedTypeName: `io.cucumber.java8.Te`
...
<RunRecipe
  recipeName="org.openrewrite.cucumber.jvm.FixTeluguLanguageCode"
  displayName="Fix the Telugu language code"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.FixTeluguLanguageCode" />
