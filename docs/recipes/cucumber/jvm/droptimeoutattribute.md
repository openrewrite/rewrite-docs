...
_Cucumber-JVM 5.0.0 removed the `timeout` attribute from step definition and hook annotations, in favor of asserting on the duration from within the step definition itself._
...
* [Remove annotation attribute](../../java/removeannotationattribute)
  * annotationType: `cucumber.api.java..*`
  * attributeName: `timeout`
* [Remove annotation attribute](../../java/removeannotationattribute)
  * annotationType: `io.cucumber.java..*`
  * attributeName: `timeout`
...
<RunRecipe
  recipeName="org.openrewrite.cucumber.jvm.DropTimeoutAttribute"
  displayName="Drop the `timeout` attribute"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.cucumber.jvm.DropTimeoutAttribute" />
