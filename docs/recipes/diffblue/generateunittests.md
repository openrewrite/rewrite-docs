...
| `List` | arguments | *Optional*. Additional arguments to pass to Diffblue Cover. See the available arguments in the [Cover CLI documentation](https://docs.diffblue.com/features/cover-cli/commands-and-arguments#argument-summary). | `--no-spring-tests` |
...
|arguments|`List.of("--keep-partial-tests")`|
...
```shell title="shell"
mod run . --recipe GenerateUnitTests --recipe-option "license=YOUR-LICENSE-KEY" --recipe-option "iterations=1000" --recipe-option "skipVerification=false" --recipe-option "arguments=--no-spring-tests"
```
...
<TabItem value="io.moderne.diffblue.table.CompileErrors" label="CompileErrors">

### Java compiler errors
**io.moderne.diffblue.table.CompileErrors**

_The errors generated by the Java compiler preparing sources for test generation._

| Column Name | Description |
| ----------- | ----------- |
| Diagnostic kind | The kind or severity of a diagnostic. |
| Source | The related source code. |
| Line | Line number. |
