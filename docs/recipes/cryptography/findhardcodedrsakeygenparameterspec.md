...
# Find hardcoded numbers passed into `RSAKeyGenParameterSpec`

**io.moderne.cryptography.FindHardcodedRSAKeyGenParameterSpec**

_It is usually insecure to pass hardcoded numbers passed into `RSAKeyGenParameterSpec`._
...
```shell title="shell"
mod run . --recipe FindHardcodedRSAKeyGenParameterSpec
```
...
<RecipeCallout link="https://app.moderne.io/recipes/io.moderne.cryptography.FindHardcodedRSAKeyGenParameterSpec" />
