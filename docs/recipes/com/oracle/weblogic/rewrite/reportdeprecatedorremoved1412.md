...
* [Report types deprecated or removed in WebLogic version 14.1.2](/recipes/com/oracle/weblogic/rewrite/checkandcommentoutdeprecations1412.md)
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.oracle.weblogic.rewrite.ReportDeprecatedOrRemoved1412</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=com.oracle.weblogic.rewrite.ReportDeprecatedOrRemoved1412 -Drewrite.exportDatatables=true
```
</TabItem>
