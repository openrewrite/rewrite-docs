...
[GitHub](https://github.com/search?type=code&q=org.apache.camel.upgrade.customRecipes.ChangePropertyKeyWithCaseChange), [Issue Tracker](https://github.com/openrewrite/rewrite-third-party/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-third-party/0.12.1/jar)
...
Now that `com.yourorg.ChangePropertyKeyWithCaseChangeExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-third-party:0.12.1 in your build file:
