---
sidebar_label: "Migrate moved types between Came 3.x and Camel 4.x"
---
...
[GitHub](https://github.com/search?type=code&q=org.apache.camel.updates.camel40.ChangeTypes), [Issue Tracker](https://github.com/openrewrite/rewrite-third-party/issues), [Maven Central](https://central.sonatype.com/artifact/org.openrewrite.recipe/rewrite-third-party/0.8.0/jar)
...
name: org.apache.camel.updates.camel40.ChangeTypes
...
<TabItem value="gradle" title="Gradle">
    ...
    rewrite {
        activeRecipe("org.apache.camel.updates.camel40.ChangeTypes")
        ...
        <plugins>
          <plugin>
            ...
            <configuration>
              ...
              <activeRecipes>
                <recipe>org.apache.camel.updates.camel40.ChangeTypes</recipe>
              </activeRecipes>
            </configuration>
            <dependencies>
              <dependency>
...
<TabItem value="maven-command-line" title="Maven Command Line">
    ...
    ```shell title="shell"
    mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=org.apache.camel.updates.camel40.ChangeTypes -Drewrite.exportDatatables=true
    ```
</TabItem>
...
<a href="https://app.moderne.io/recipes/org.apache.camel.updates.camel40.ChangeTypes">
    <img
