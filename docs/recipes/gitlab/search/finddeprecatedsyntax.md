...
rewrite {
    activeRecipe("org.openrewrite.gitlab.search.FindDeprecatedSyntax")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.gitlab.search.FindDeprecatedSyntax</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-gitlab:RELEASE -Drewrite.activeRecipes=org.openrewrite.gitlab.search.FindDeprecatedSyntax -Drewrite.exportDatatables=true
```
</TabItem>
