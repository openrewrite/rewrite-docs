...
Now that `com.yourorg.AddOrUpdateLabelExample` has been defined, activate it and take a dependency on `org.openrewrite:rewrite-docker:{{VERSION_ORG_OPENREWRITE_REWRITE_DOCKER}}` in your build file:
...
rewrite {
    activeRecipe("com.yourorg.AddOrUpdateLabelExample")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>com.yourorg.AddOrUpdateLabelExample</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
