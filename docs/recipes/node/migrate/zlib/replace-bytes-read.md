...
* [DEP0108](/reference/recipes-by-tag#dep0108)

## Recipe source

[GitHub](https://github.com/search?type=code&q=repo:openrewrite/rewrite+org.openrewrite.node.migrate.zlib.replace-bytes-read),
