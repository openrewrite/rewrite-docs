...
rewrite {
    activeRecipe("io.quarkus.updates.core.quarkus331.Testcontainers2")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>io.quarkus.updates.core.quarkus331.Testcontainers2</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-third-party:RELEASE -Drewrite.activeRecipes=io.quarkus.updates.core.quarkus331.Testcontainers2 -Drewrite.exportDatatables=true
```
</TabItem>
