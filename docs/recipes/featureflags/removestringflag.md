...
Now that `com.yourorg.RemoveStringFlagExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-feature-flags:0.8.1 in your build file:
