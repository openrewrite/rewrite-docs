...
[GitHub: rewrite-liberty-1.23.5.jar](https://github.com/openrewrite/rewrite-liberty/blob/main/src/main/java/org/openrewrite/xml/liberty/WebBeansXmlRule.java),
