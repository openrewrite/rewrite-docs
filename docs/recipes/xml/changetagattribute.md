...
[Code Genome Project](https://artifacts.codegenomeproject.org/maven/org/openrewrite/rewrite-xml/)
...
* [Migrate xmlns entries in `**/batch-jobs/*.xml` files.](/recipes/oracle/weblogic/rewrite/jakarta/javaxbatchjobsxmlstojakarta9batchjobsxmls.md)
...
* [Migrate xmlns entries in `*-jdbc.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicjdbcxmlnamespace1412.md)
* [Migrate xmlns entries in `*-jms.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicjmsxmlnamespace1412.md)
...
* [Migrate xmlns entries in `application-client.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicapplicationclientxmlnamespace1412.md)
...
* [Migrate xmlns entries in `beans.xml` files for Beans 3.0.](/recipes/oracle/weblogic/rewrite/jakarta/javaxbeansxmltojakarta9beansxml.md)
...
* [Migrate xmlns entries in `persistence-configuration.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicpersistenceconfigurationxmlnamespace1412.md)
...
* [Migrate xmlns entries in `persistence.xml` files](/recipes/quarkus/updates/core/quarkus30/javaxpersistencexmltojakartapersistencexml.md)
* [Migrate xmlns entries in `plan.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicplanxmlnamespace1412.md)
* [Migrate xmlns entries in `ra.xml` files (Connectors).](/recipes/oracle/weblogic/rewrite/jakarta/javaxraxmltojakarta9raxml.md)
* [Migrate xmlns entries in `resource-deployment-plan.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicresourcedeploymentplanxmlnamespace1412.md)
...
* [Migrate xmlns entries in `test-web.xml` files for Jakarta Server Faces 3 using test interfaces](/recipes/oracle/weblogic/rewrite/jakarta/javaxtestwebxmltojakartatestwebxml5.md)
...
* [Migrate xmlns entries in `weblogic-application.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicapplicationxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-ejb-jar.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicejbjar32xmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-pubsub.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicpubsubxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-ra.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicraxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-rdbms-jar.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicrdbmsjarxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-webservices-policy.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicwebservicespolicyrefxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-webservices.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicwebservicesxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-wsee-clientHandlerChain.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicwseeclienthandlerchainxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic-wsee-standaloneclient.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicwseestandaloneclientxmlnamespace1412.md)
* [Migrate xmlns entries in `weblogic.xml` files to WebLogic 14.1.2](/recipes/oracle/weblogic/rewrite/weblogicxmlwebappnamespace1412.md)
