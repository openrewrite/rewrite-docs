...
* [Migrate `AuthState` to `AuthExchange`](./migrateauthstate.md)
...
* [Inline hoisted locals used by `new BasicAsyncRequestProducer(...)`](./inlinebasicasyncrequestproducerlocals.md)
* [Migrate `AuthScheme` credential handling](./migrateauthschemecredentials.md)
* [Migrate `BasicAsyncRequestProducer` to `AsyncRequestBuilder`](./migratebasicasyncrequestproducer.md)
* [Migrate `HttpAsyncMethods` factory calls to HttpClient 5.x](./migratehttpasyncmethods.md)
