...
**org.openrewrite.apache.ApacheBestPractices**

_Apply best practices to code that uses [Apache](https://apache.org/) libraries. This migrates Apache Commons, [HttpClient](https://hc.apache.org/) and [POI](https://poi.apache.org/) off their end-of-life major versions, replaces deprecated APIs with their supported replacements, and prefers the Java standard library where it now offers an equivalent._
...
[GitHub: apache-best-practices.yml](https://github.com/openrewrite/rewrite-apache/blob/main/src/main/resources/META-INF/rewrite/apache-best-practices.yml),
...
* [Apache Commons best practices](../apache/commons/apachecommonsbestpractices)
* [Migrate to ApacheHttpClient 5.x](../apache/httpclient5/upgradeapachehttpclient_5)
* [Migrates to Apache POI 5.x](../apache/poi/upgradeapachepoi_5)
...
name: org.openrewrite.apache.ApacheBestPractices
...
## Examples
##### Example 1
`ApacheBestPracticesTest#migrateHttpClient`
...
<RunRecipe
  recipeName="org.openrewrite.apache.ApacheBestPractices"
  displayName="Apache best practices"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.apache.ApacheBestPractices" />
