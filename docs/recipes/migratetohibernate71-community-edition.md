...
[GitHub](https://github.com/openrewrite/rewrite-hibernate/blob/main/src/main/resources/META-INF/rewrite/hibernate-7.1.yml),
...
* [Migrate to Hibernate 7.0.x (Community Edition)](migratetohibernate70-community-edition)
...
* [Migrate to Hibernate 7.1.x (Moderne Edition)](/recipes/migratetohibernate71-moderne-edition.md)
