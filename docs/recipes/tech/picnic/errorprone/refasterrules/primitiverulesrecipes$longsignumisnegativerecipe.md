...
_Recipe created for the following Refaster template: ```java static final class LongSignumIsNegative &lcub;          @BeforeTemplate     boolean before(long l) &lcub;         return Refaster.anyOf(Long.signum(l) &lt; 0, Long.signum(l) &lt;= -1);     &rcub;          @AfterTemplate     @AlsoNegation     boolean after(long l) &lcub;         return Long.signum(l) == -1;     &rcub; &rcub; ``` ._
...
<a href="https://app.moderne.io/recipes/tech.picnic.errorprone.refasterrules.PrimitiveRulesRecipes$LongSignumIsNegativeRecipe">
    <img
