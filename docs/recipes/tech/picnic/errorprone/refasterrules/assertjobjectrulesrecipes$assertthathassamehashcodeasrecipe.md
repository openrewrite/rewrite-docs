...
[GitHub: rewrite-third-party-0.34.0.jar](https://github.com/search?type=code&q=tech.picnic.errorprone.refasterrules.AssertJObjectRulesRecipes$AssertThatHasSameHashCodeAsRecipe),
...
* [`AssertJObjectRules` Refaster recipes](/recipes/tech/picnic/errorprone/refasterrules/assertjobjectrulesrecipes.md)
