...
rewrite {
    activeRecipe("org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery")
    ...
    <plugins>
      <plugin>
        ...
        <configuration>
          ...
          <activeRecipes>
            <recipe>org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery</recipe>
          </activeRecipes>
        </configuration>
        <dependencies>
          <dependency>
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-spring-to-quarkus:RELEASE -Drewrite.activeRecipes=org.openrewrite.quarkus.spring.MigrateSpringCloudServiceDiscovery -Drewrite.exportDatatables=true
```
</TabItem>
