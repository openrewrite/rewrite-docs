...
* [rest](/reference/recipes-by-tag#rest)
* [data](/reference/recipes-by-tag#data)
* [quarkus](/reference/recipes-by-tag#quarkus)

## Recipe source

[GitHub](https://github.com/openrewrite/rewrite-spring-to-quarkus/blob/main/src/main/java/org/openrewrite/quarkus/spring/SpringBootDataRestToQuarkus.java),
