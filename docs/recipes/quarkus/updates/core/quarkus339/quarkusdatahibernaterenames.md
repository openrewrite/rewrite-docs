...
**io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames**

_Migrate from `io.quarkus.hibernate.panache` to `io.quarkus.data.hibernate` package and rename Panache types to Quarkus Data types._

## Recipe source

[GitHub: search?type=code&q=io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames](https://github.com/search?type=code&q=io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames),
...
name: io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames
...
recipeList:
  - io.quarkus.updates.core.quarkus339.ChangeTypeWithInnerClass:
      oldFullyQualifiedTypeName: io.quarkus.hibernate.panache.PanacheEntity$Reactive$Stateless
      newFullyQualifiedTypeName: io.quarkus.data.hibernate.RecordEntity$Reactive$CustomId
  - io.quarkus.updates.core.quarkus339.ChangeTypeWithInnerClass:
      oldFullyQualifiedTypeName: io.quarkus.hibernate.panache.PanacheEntity$Reactive
...
<RunRecipe
  recipeName="io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames"
  displayName="Rename Quarkus Hibernate Panache types to Quarkus Data Hibernate"
...
<RecipeCallout link="https://app.moderne.io/recipes/io.quarkus.updates.core.quarkus339.QuarkusDataHibernateRenames" />
