...
* [Add Terraform configuration](../../terraform/addconfiguration)
  ...
  * content: `metadata = {   block-project-ssh-keys = true }`
...
<a href="https://app.moderne.io/recipes/org.openrewrite.terraform.gcp.EnsureGCPVMInstancesHaveBlockProjectWideSSHKeysFeatureEnabled">
    <img
