...
* [Add Terraform configuration](../../terraform/addconfiguration)
  ...
  * content: `addon_profile {   azure_policy {     enabled = false   } }`
...
```shell title="shell"
mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-terraform:RELEASE -Drewrite.activeRecipes=org.openrewrite.terraform.azure.EnsureAKSPoliciesAddOn -Drewrite.exportDatatables=true
```
</TabItem>
...
<a href="https://app.moderne.io/recipes/org.openrewrite.terraform.azure.EnsureAKSPoliciesAddOn">
    <img
