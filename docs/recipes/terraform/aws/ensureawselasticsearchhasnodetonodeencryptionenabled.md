...
* [Add Terraform configuration](../../terraform/addconfiguration)
  ...
  * content: `node_to_node_encryption {   enabled = true }`
...
<a href="https://app.moderne.io/recipes/org.openrewrite.terraform.aws.EnsureAWSElasticsearchHasNodeToNodeEncryptionEnabled">
    <img
