...
* [Add Terraform configuration](../../terraform/addconfiguration)
  ...
  * content: `encrypt_at_rest {   enabled = true }`
...
<a href="https://app.moderne.io/recipes/org.openrewrite.terraform.aws.EnsureAWSElasticsearchDomainEncryptionForDataAtRestIsEnabled">
    <img
