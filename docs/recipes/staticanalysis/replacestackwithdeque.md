...
_From the Javadoc of `Stack`: &gt; A more complete and consistent set of LIFO stack operations is provided by the Deque interface and its implementations, which should be used in preference to this class._
...
<a href="https://app.moderne.io/recipes/org.openrewrite.staticanalysis.ReplaceStackWithDeque">
    <img
