...
* [Replace `java.util.Hashtable` with `java.util.HashMap`](../staticanalysis/replacehashtablewithhashmap)
* [Replace `java.util.Vector` with `java.util.ArrayList`](../staticanalysis/replacevectorwitharraylist)
* [Replace `java.util.Stack` with `java.util.Deque`](../staticanalysis/replacestackwithdeque)
* [Replace `java.lang.StringBuffer` with `java.lang.StringBuilder`](../staticanalysis/replacestringbufferwithstringbuilder)
...
<RunRecipe
  recipeName="org.openrewrite.staticanalysis.ModernizeCollections"
  displayName="Modernize collections"
...
<RecipeCallout link="https://app.moderne.io/recipes/org.openrewrite.staticanalysis.ModernizeCollections" />
