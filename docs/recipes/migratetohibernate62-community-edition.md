...
* [Migrate to Hibernate 6.1.x (Community Edition)](migratetohibernate61-community-edition)
...
* [Upgrade Gradle or Maven dependency versions](java/dependencies/upgradedependencyversion)
  ...
  * artifactId: `*`
  * newVersion: `6.2.x`
* [Replace `@LazyCollection` with `jakarta.persistence.FetchType` (Community Edition)](replacelazycollectionannotation-community-edition)
