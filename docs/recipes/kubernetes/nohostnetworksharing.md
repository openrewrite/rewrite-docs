...
<TabItem value="maven-command-line" title="Maven Command Line">
    ...
    ```shell title="shell"
    mvn -U org.openrewrite.maven:rewrite-maven-plugin:run -Drewrite.recipeArtifactCoordinates=org.openrewrite.recipe:rewrite-kubernetes:RELEASE -Drewrite.activeRecipes=org.openrewrite.kubernetes.NoHostNetworkSharing -Drewrite.exportDatatables=true
    ```
</TabItem>
...
<a href="https://app.moderne.io/recipes/org.openrewrite.kubernetes.NoHostNetworkSharing">
    <img
