...
Now that `com.yourorg.FindMissingOrInvalidLabelExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.11.1 in your build file:
