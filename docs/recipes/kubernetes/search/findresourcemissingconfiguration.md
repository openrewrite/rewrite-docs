...
Now that `com.yourorg.FindResourceMissingConfigurationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.9.0 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.kubernetes.search.FindResourceMissingConfiguration">
    <img
