...
Now that `com.yourorg.FindResourceMissingConfigurationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.10.1 in your build file:
