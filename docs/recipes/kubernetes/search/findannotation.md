...
Now that `com.yourorg.FindAnnotationExample` has been defined, activate it and take a dependency on org.openrewrite.recipe:rewrite-kubernetes:2.9.1 in your build file:
...
<a href="https://app.moderne.io/recipes/org.openrewrite.kubernetes.search.FindAnnotation">
    <img
