...
<Tabs>
<TabItem value="deprecated-mutiny-apis-before" label="Deprecated Mutiny APIs (Before)">
...
<TabItem value="deprecated-mutiny-apis-after" label="Deprecated Mutiny APIs (After)">
...
<Tabs>
<TabItem value="io.quarkus.qute.api.*-before" label="io.quarkus.qute.api.* (Before)">
...
<TabItem value="io.quarkus.qute.api.*-after" label="io.quarkus.qute.api.* (After)">
...
<Tabs>
<TabItem value="application.properties-before" label="application.properties (Before)">
...
<TabItem value="application.properties-after" label="application.properties (After)">
