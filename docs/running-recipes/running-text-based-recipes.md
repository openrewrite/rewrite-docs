...
description: How to create and run a text based recipe.
---
...
Your Code Genome Project credentials go in your Maven `settings.xml` file (typically at `~/.m2/settings.xml`):
