...
### [Find hardcoded PEM certificates](../cryptography/findhardcodedcertificate.md)
...
### [Find hardcoded PEM private keys](../cryptography/findhardcodedprivatekey.md)
...
### [Remove table from single table inherited entity](../hibernate/update66/removetablefrominheritedentity.md)
...
### [Is likely not a Spring Boot project](../java/spring/boot/islikelynotspringboot.md)
_io.moderne.java.spring.boot.IsLikelyNotSpringBoot_

Marks the project if it's likely not a Spring Boot project.

### [Is likely a Spring Boot project](../java/spring/boot/islikelyspringboot.md)
_io.moderne.java.spring.boot.IsLikelySpringBoot_

Marks the project if it's likely a Spring Boot project.

### [Migrate Spring Framework Dependencies to Spring Boot](../java/spring/boot/migratespringframeworkdependenciestospringboot.md)
...
### [Migrate management endpoint access value](../java/spring/boot3/migrateendpointaccessvaluespring34.md)
...
### [Is likely a Spring Framework project](../java/spring/framework/islikelyspringframework.md)
_io.moderne.java.spring.framework.IsLikelySpringFramework_

Marks the project if it's likely a Spring Framework project.

### [Migrate ´web.xml` to `WebApplicationInitializer`](../java/spring/framework/webxml/webxmltowebapplicationinitializer.md)
...
### [Use [VulnCheck Exploit Intelligence](https://docs.vulncheck.com/products/exploit-and-vulnerability-intelligence/exploit-intelligence) to fix vulnerabilities](../vulncheck/fixvulncheckvulnerabilities.md)
...
### [Remove ignoral of files or directories from .gitignore](../core/excludefilefromgitignore.md)
...
### [Repository contains file](../search/repositorycontainsfile.md)
...
### [Append to text file](../text/appendtotextfile.md)
...
### [Module has dependency](../gradle/search/modulehasdependency.md)
...
### [Module has plugin](../gradle/search/modulehasplugin.md)
...
### [Find the oldest Java version in use](../java/search/hasminimumjavaversion.md)
...
### [Add the Develocity Maven extension](../maven/adddevelocitymavenextension.md)
...
### [Add a configuration option for the Maven runtime](../maven/addruntimeconfig.md)
_org.openrewrite.maven.AddRuntimeConfig_

Add a new configuration option for the Maven runtime if not already present.

### [Increment Maven project version](../maven/incrementprojectversion.md)
...
### [Manage dependencies](../maven/managedependencies.md)
...
### [Remove unused properties](../maven/removeunusedproperties.md)
...
### [Update Maven wrapper](../maven/updatemavenwrapper.md)
...
### [Module has dependency](../maven/search/modulehasdependency.md)
...
### [Module has plugin](../maven/search/modulehasplugin.md)
...
### [Create Properties file](../properties/createpropertiesfile.md)
_org.openrewrite.properties.CreatePropertiesFile_

Create a new Properties file.

### [Create XML file](../xml/createxmlfile.md)
...
### [Create YAML file](../yaml/createyamlfile.md)
_org.openrewrite.yaml.CreateYamlFile_

Create a new YAML file.

### [Finds flow between two methods](../analysis/search/findflowbetweenmethods.md)
...
### [Biome recommendations](../codemods/biome.md)
...
### [Update README](../knowledge/docs/updatereadme.md)
...
### [Search for a class that uses the given design technique](../knowledge/search/searchdesigntechnique.md)
...
### [Upgrade transitive Gradle or Maven dependencies](../java/dependencies/upgradetransitivedependencyversion.md)
...
### [Module has dependency](../java/dependencies/search/modulehasdependency.md)
...
### [Repository has dependency](../java/dependencies/search/repositoryhasdependency.md)
...
### [Remove unused dependencies](../java/dependencies/removeunuseddependencies.md)
...
### [Software bill of materials](../java/dependencies/softwarebillofmaterials.md)
...
### [Prevent clickjacking](../java/security/spring/preventclickjacking.md)
...
### [Create `index.jelly` if it doesn't exist](../jenkins/createindexjelly.md)
...
### [Add plugin developer team to CODEOWNERS](../jenkins/github/addteamtocodeowners.md)
...
### [Adds `static` modifier to `@Produces` fields that are in session beans](../java/migrate/addstaticvariableonproducersessionbean.md)
...
### [Project has no Jakarta annotations](../java/migrate/jakarta/hasnojakartaannotations.md)
...
### [Add scope annotation to injected classes](../java/migrate/javax/addscopetoinjectedclass.md)
...
### [Migrate Joda-Time to Java time](../java/migrate/joda/jodatimerecipe.md)
_org.openrewrite.java.migrate.joda.JodaTimeRecipe_

Prefer the Java standard library over third-party usage of Joda Time.

### [Rename getter methods to fit Lombok](../java/migrate/lombok/adoptlombokgettermethodnames.md)
...
### [Extract documentation examples from tests](../java/recipes/examplesextractor.md)
...
### [Rename bean](../java/spring/renamebean.md)
_org.openrewrite.java.spring.RenameBean_

Renames a Spring bean, both declaration and references.

### [Separate application YAML by profile](../java/spring/separateapplicationyamlbyprofile.md)
...
### [Update the API manifest](../java/spring/updateapimanifest.md)
...
### [Merge Spring `bootstrap.yml` with `application.yml`](../java/spring/boot2/mergebootstrapyamlwithapplicationyaml.md)
...
### [Integration scheduler pool size](../java/spring/boot2/search/integrationschedulerpoolrecipe.md)
...
### [Maintain trailing slash URL mappings](../java/spring/boot3/maintaintrailingslashurlmappings.md)
...
### [Migrate `Docket` to `GroupedOpenAPI`](../java/spring/doc/migratedocketbeantogroupedopenapibean.md)
...
### [Upgrade Spring dependencies](../maven/spring/upgradeexplicitspringbootdependencies.md)
...
### [Replace `verifyZeroInteractions()` to `verifyNoMoreInteractions()](../java/testing/mockito/verifyzerotonomoreinteractions.md)
