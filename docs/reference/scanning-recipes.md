...
* [Add `@SpringBootApplication` class](/recipes/java/spring/boot3/addspringbootapplication.md) - _Adds a `@SpringBootApplication` class containing a main method to bootify your Spring Framework application._
