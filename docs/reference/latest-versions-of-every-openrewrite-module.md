...
|-----------------------------------------------------------------------------------------------------------------------| ---------- | ------- |
| [**org.openrewrite:rewrite-bom**](https://github.com/openrewrite/rewrite)                                             | **[8.85.5](https://github.com/openrewrite/rewrite/releases/tag/v8.85.5)** | [Apache License Version 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
