...
|-----------------------------------------------------------------------------------------------------------------------| ---------- | ------- |
| [**org.openrewrite:rewrite-bom**](https://github.com/openrewrite/rewrite)                                             | **[8.81.16](https://github.com/openrewrite/rewrite/releases/tag/v8.81.16)** | [Apache License Version 2.0](https://www.apache.org/licenses/LICENSE-2.0) |
