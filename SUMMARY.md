...
* [Recipes](reference/recipes/README.md)
  * [Java](reference/recipes/java/README.md)
    ...
    * [Spring](reference/recipes/java/spring/README.md)
      ...
      * [Change Deprecated Hibernate validation constraints to their associated javax variant](reference/recipes/java/spring/change-deprecated-hibernate-validation-constraints-to-their-associated-javax-variant.md)
      * [Remove Implicit Web Annotation Names](reference/recipes/java/spring/implicitwebannotationnames.md)
      * [Add the javax validation-api and spring-boot-starter-validation if necessary](reference/recipes/java/spring/add-the-javax-validation-api-and-spring-boot-starter-validation-if-necessary.md)
