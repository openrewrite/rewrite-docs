...
* [Testing](java/testing/README.md)
  * [Mockito](java/testing/mockito/README.md)
    * [ArgumentMatchersAny](java/testing/mockito/argumentmatchersany.md)
    * [InvocationOnMockGetArgument](java/testing/mockito/invocationonmockgetargument.md)
    * [MockAsOuterClass](java/testing/mockito/mockasouterclass.md)
    * [MockUtilsToStatic](java/testing/mockito/mockutilstostatic.md)
  * [JUnit](java/testing/junit/README.md)
    * [TemporaryFolderToTempDir](java/testing/junit/temporaryfoldertotempdir.md)
    * [SpringRunnerToSpringExtension](java/testing/junit/springrunnertospringextension.md)
    * [ChangeTestAnnotation](java/testing/junit/changetestannotation.md)
    * [AssumeToAssumptions](java/testing/junit/assumetoassumptions.md)
    * [ReplaceAnnotations](java/testing/junit/replaceannotations.md)
