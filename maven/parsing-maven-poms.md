...
You can then perform structured search or transformation on those build files. To apply Rewrite recipes affecting Maven POM files, refer instead to the guides on the [Maven](../java/rewrite-maven-plugin.md) or [Gradle ](../java/rewrite-gradle-plugin.md)plugins.
