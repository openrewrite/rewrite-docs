...
const globalVariables = {
  "{{VERSION_REWRITE_RECIPE_BOM}}": "2.21.0",
  "{{VERSION_REWRITE_GRADLE_PLUGIN}}": "6.25.0",
  "{{VERSION_REWRITE_JAVA_DEPENDENCIES}}": "1.20.0",
  "{{VERSION_REWRITE_LOGGING_FRAMEWORKS}}": "2.15.0",
  "{{VERSION_REWRITE_MAVEN_PLUGIN}}": "5.42.0",
  "{{VERSION_REWRITE_MIGRATE_JAVA}}": "2.26.1",
  "{{VERSION_REWRITE_TEMPLATING}}": "1.16.1",
  "{{VERSION_REWRITE_TESTING_FRAMEWORKS}}": "2.20.0",
  "{{VERSION_REWRITE_SPRING}}": "5.21.0",
  "{{VERSION_REWRITE_STATIC_ANALYSIS}}": "1.18.0",
};
