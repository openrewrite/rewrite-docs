...
dependencies {
    ...
    implementation("org.openrewrite:rewrite-java:7.14.0")
    runtimeOnly("org.openrewrite:rewrite-java-11:7.14.0")
    runtimeOnly("org.openrewrite:rewrite-java-8:7.14.0")

    // rewrite-maven dependency only necessary for Maven Recipe development
    implementation("org.openrewrite:rewrite-maven:7.14.0")

    // rewrite-yaml dependency only necessary for Yaml Recipe development
    implementation("org.openrewrite:rewrite-yaml:7.14.0")

    // rewrite-properties dependency only necessary for Properties Recipe development
    implementation("org.openrewrite:rewrite-properties:7.14.0")

    // rewrite-xml dependency only necessary for XML Recipe development
    implementation("org.openrewrite:rewrite-xml:7.14.0")

    // For authoring tests for any kind of Recipe
    testImplementation("org.openrewrite:rewrite-test:7.14.0")
}
```
{% endtab %}
